...
| [testing.md](testing.md)                   | How to run the gate; **the seven conformance metrics and what each is blind to**; the wasmtk WAT corpus runner and the fact that `tests/wasmtk/` is a FROZEN SNAPSHOT (`PROVENANCE.md`); regression-test placement                                                                                                                      |
