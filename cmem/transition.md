...
**30 items across 4 phases and 5 entities** — A:17, B:6, C:3, D:4. Everything below is either done, or gated on something
named.
...
- **907 tests green** *(513 + 393 + 1 new sync test; re-derive, do not trust the arithmetic)*
...
*future* resolution of the old names. "Clean break" sounds like the bold option and is the
