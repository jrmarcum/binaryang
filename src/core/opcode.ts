...
const EXTENDED_OPCODE_NAMES: ReadonlyMap<number, string> = new Map<number, string>([
  ...
  [(PREFIX_SIMD << 8) | 0x0b, 'v128.load64_zero'],
  ...
  [(PREFIX_SIMD << 8) | 0x58, 'v128.bitselect'],
  [(PREFIX_SIMD << 8) | 0x59, 'v128.any_true'],
  [(PREFIX_SIMD << 8) | 0x5c, 'v128.load32_zero'],
  [(PREFIX_SIMD << 8) | 0x5d, 'v128.load64_zero'],
  [(PREFIX_SIMD << 8) | 0x5e, 'v128.store8_lane'],
  [(PREFIX_SIMD << 8) | 0x5f, 'v128.store16_lane'],
  [(PREFIX_SIMD << 8) | 0x60, 'v128.store32_lane'],
  [(PREFIX_SIMD << 8) | 0x61, 'v128.store64_lane'],
