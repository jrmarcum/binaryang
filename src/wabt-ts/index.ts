 ...
 * - `jsr:@jrmarcum/binaryang/wat2wasm`
 * - `jsr:@jrmarcum/binaryang/wasm2wat`
 * - `jsr:@jrmarcum/binaryang/wasm-validate`
 * - `jsr:@jrmarcum/binaryang/wasm-objdump`
 * - `jsr:@jrmarcum/binaryang/wasm2ts`
 *
 * @example
 * ```ts
