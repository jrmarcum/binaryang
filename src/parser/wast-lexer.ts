...
const KEYWORDS: ReadonlyMap<string, KwInfo> = new Map<string, KwInfo>([
  ...
  ['definition', bare(TokenType.Definition)],
  ...
  ['array.new', op(TokenType.ArrayNew, G(GcOpcode.ArrayNew))],
  ['array.new_default', op(TokenType.ArrayNewDefault, G(GcOpcode.ArrayNewDefault))],
  ['array.new_fixed', op(TokenType.ArrayNewFixed, G(GcOpcode.ArrayNewFixed))],
  ['array.new_data', op(TokenType.ArrayNewData, G(GcOpcode.ArrayNewData))],
  ['array.new_elem', op(TokenType.ArrayNewElem, G(GcOpcode.ArrayNewElem))],
  ['array.get', op(TokenType.ArrayGet, G(GcOpcode.ArrayGet))],
  ['array.get_s', op(TokenType.ArrayGet, G(GcOpcode.ArrayGetS))],
  ...
  ['f32x4.ceil', op(TokenType.Unary, S(0x67))],
  ['f32x4.floor', op(TokenType.Unary, S(0x68))],
  ['f32x4.trunc', op(TokenType.Unary, S(0x69))],
  ['f32x4.nearest', op(TokenType.Unary, S(0x6a))],
  ['f32x4.add', op(TokenType.Binary, S(0xe4))],
  ['f32x4.sub', op(TokenType.Binary, S(0xe5))],
  ['f32x4.mul', op(TokenType.Binary, S(0xe6))],
  ['f32x4.div', op(TokenType.Binary, S(0xe7))],
  ['f32x4.min', op(TokenType.Binary, S(0xe8))],
  ['f32x4.max', op(TokenType.Binary, S(0xe9))],
  ['f32x4.pmin', op(TokenType.Binary, S(0xea))],
  ['f32x4.pmax', op(TokenType.Binary, S(0xeb))],
  ...
  ['f64x2.abs', op(TokenType.Unary, S(0xec))],
  ['f64x2.neg', op(TokenType.Unary, S(0xed))],
  ['f64x2.sqrt', op(TokenType.Unary, S(0xef))],
  ['f64x2.ceil', op(TokenType.Unary, S(0x74))],
  ['f64x2.floor', op(TokenType.Unary, S(0x75))],
  ['f64x2.trunc', op(TokenType.Unary, S(0x7a))],
  ['f64x2.nearest', op(TokenType.Unary, S(0x94))],
  ['f64x2.add', op(TokenType.Binary, S(0xf0))],
  ['f64x2.sub', op(TokenType.Binary, S(0xf1))],
  ['f64x2.mul', op(TokenType.Binary, S(0xf2))],
  ['f64x2.div', op(TokenType.Binary, S(0xf3))],
  ['f64x2.min', op(TokenType.Binary, S(0xf4))],
  ['f64x2.max', op(TokenType.Binary, S(0xf5))],
  ['f64x2.pmin', op(TokenType.Binary, S(0xf6))],
  ['f64x2.pmax', op(TokenType.Binary, S(0xf7))],
