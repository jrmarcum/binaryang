...
const VALUE_ON_STACK = new Uint8Array([
  ...
  0xe4,
  0x00,
  0x0b, // global mut i32 = 100 (signed LEB e4 00)
  0x07,
  0x05,
  0x01,
  0x01,
  ...
  0x01,
  0x0c,
  0x00, // code: 1 body, size 12, 0 declared locals
  0x23,
  0x00,
  0x41,
  0x2a,
  ...
  0x23,
  0x00,
  0x0b, // g.get; c42; g.set; g.set; g.get; end
]);
...
Deno.test('the spilled decode round-trips and executes correctly (f() === 100)', async () => {
  ...
  assertEquals((instance.exports.f as () => number)(), 100);
});
