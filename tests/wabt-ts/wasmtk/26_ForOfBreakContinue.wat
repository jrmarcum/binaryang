(module
  ...
  (func $testForOfLoops (export "testForOfLoops")  
    (local $staticArr i32)
    (local $sum i32)
    (local $item i32)
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 288))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $staticArr (i32.const 260))
    (local.set $sum (i32.const 0))
    (local.set $__forof_idx (i32.const 0))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.ge_u (local.get $__forof_idx) (i32.const 5)))
        (local.set $item (i32.load (i32.add (i32.const 268) (i32.shl (local.get $__forof_idx) (i32.const 2)))))
        (block $cont_0
          (if (i32.eq (local.get $item) (i32.const 20))
            (then
            (br $cont_0)
            )
          )
          (if (i32.eq (local.get $item) (i32.const 40))
            (then
            (br $break_0)
            )
          )
          (local.set $sum (i32.add (local.get $sum) (local.get $item)))
        )
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 70))
          ...
          (i32.store8 (i32.const 151) (i32.const 100))
          (i32.store8 (i32.const 152) (i32.const 32))
          (i32.store8 (i32.const 153) (i32.const 83))
          (i32.store8 (i32.const 154) (i32.const 117))
          (i32.store8 (i32.const 155) (i32.const 109))
          (i32.store8 (i32.const 156) (i32.const 58))
          (i32.store8 (i32.const 157) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 26) (call $__i32_to_str (local.get $sum) (i32.const 158))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $dynArr (call $__malloc (i32.const 40)))
      (i32.store (local.get $dynArr) (i32.const 0))
      (i32.store offset=4 (local.get $dynArr) (i32.const 8))
    (local.set $dynArr (call $__dynarr_push_i32 (local.get $dynArr) (i32.const 1)))
    (local.set $dynArr (call $__dynarr_push_i32 (local.get $dynArr) (i32.const 2)))
    (local.set $dynArr (call $__dynarr_push_i32 (local.get $dynArr) (i32.const 3)))
    (local.set $product (i32.const 1))
    (local.set $__forof_idx (i32.const 0))
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.ge_u (local.get $__forof_idx) (i32.load (local.get $dynArr))))
        (local.set $num (i32.load (i32.add (i32.add (local.get $dynArr) (i32.const 8)) (i32.shl (local.get $__forof_idx) (i32.const 2)))))
        (block $cont_1
          (local.set $product (i32.mul (local.get $product) (local.get $num)))
        )
        (local.set $__forof_idx (i32.add (local.get $__forof_idx) (i32.const 1)))
        (br $loop_1)
      )
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 145) (i32.const 80))
          (i32.store8 (i32.const 146) (i32.const 114))
          (i32.store8 (i32.const 147) (i32.const 111))
          (i32.store8 (i32.const 148) (i32.const 100))
          (i32.store8 (i32.const 149) (i32.const 117))
          (i32.store8 (i32.const 150) (i32.const 99))
          (i32.store8 (i32.const 151) (i32.const 116))
          (i32.store8 (i32.const 152) (i32.const 58))
          (i32.store8 (i32.const 153) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 22) (call $__i32_to_str (local.get $product) (i32.const 154))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 288) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\66\6f\72\2e\2e\2e\6f\66\20\4c\6f\6f\70\20\49\74\65\72\61\74\69\6f\6e\20\2d\2d\2d\0a")
  (data (i32.const 260) "\05\00\00\00\05\00\00\00\0a\00\00\00\14\00\00\00\1e\00\00\00\28\00\00\00\32\00\00\00")
)