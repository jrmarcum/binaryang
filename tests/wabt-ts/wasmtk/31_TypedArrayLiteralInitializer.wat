(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 299))
  ...
  (func $testTypedArrayInitializer (export "testTypedArrayInitializer")  
    (local $floats i32)
    ...
    (local $__arr_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $floats (call $__malloc (i32.const 32)))
      (i32.store (local.get $floats) (i32.const 3))
      (f64.store (i32.add (local.get $floats) (i32.const 8)) (f64.const 10.5))
      (f64.store (i32.add (local.get $floats) (i32.const 16)) (f64.const 20.25))
      (f64.store (i32.add (local.get $floats) (i32.const 24)) (f64.const 30.75))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 54))
          (i32.store8 (i32.const 138) (i32.const 52))
          ...
          (i32.store8 (i32.const 145) (i32.const 104))
          (i32.store8 (i32.const 146) (i32.const 58))
          (i32.store8 (i32.const 147) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 16) (call $__i32_to_str (i32.load (local.get $floats)) (i32.const 148))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 52))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store8 (i32.const 140) (i32.const 66))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__i32_to_str (i32.shl (i32.load (local.get $floats)) (i32.const 3)) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 52))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store8 (i32.const 140) (i32.const 73))
          (i32.store8 (i32.const 141) (i32.const 110))
          (i32.store8 (i32.const 142) (i32.const 100))
          (i32.store8 (i32.const 143) (i32.const 101))
          (i32.store8 (i32.const 144) (i32.const 120))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store8 (i32.const 146) (i32.const 48))
          (i32.store8 (i32.const 147) (i32.const 58))
          (i32.store8 (i32.const 148) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $floats) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 3)))) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 147) (i32.const 58))
          (i32.store8 (i32.const 148) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__f64_to_str (f64.load (i32.add (i32.add (local.get $floats) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 3)))) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testTypedArrayInitializer )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\54\79\70\65\64\41\72\72\61\79\20\49\6e\69\74\69\61\6c\69\7a\65\72\20\2d\2d\2d\0a")
)