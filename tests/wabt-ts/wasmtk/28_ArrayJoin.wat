(module
  ...
  (func $testArrayJoin (export "testArrayJoin")  
    (local $values i32)
    (local $defaultJoined_ptr i32)
    (local $defaultJoined_len i32)
    (local $customJoined_ptr i32)
    (local $customJoined_len i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $values (call $__malloc (i32.const 40)))
      (i32.store (local.get $values) (i32.const 4))
      (i32.store offset=4 (local.get $values) (i32.const 8))
      (i32.store offset=8 (local.get $values) (i32.const 10))
      (i32.store offset=12 (local.get $values) (i32.const 20))
      (i32.store offset=16 (local.get $values) (i32.const 30))
      (i32.store offset=20 (local.get $values) (i32.const 40))
    (call $__dynarr_join_str_i32 (local.get $values) (i32.const 289) (i32.const 1))
      (local.set $defaultJoined_len)
      (local.set $defaultJoined_ptr)
    (call $__dynarr_join_str_i32 (local.get $values) (i32.const 290) (i32.const 3))
      (local.set $customJoined_len)
      (local.set $customJoined_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 68))
          (i32.store8 (i32.const 133) (i32.const 101))
          (i32.store8 (i32.const 134) (i32.const 102))
          ...
          (i32.store8 (i32.const 140) (i32.const 74))
          (i32.store8 (i32.const 141) (i32.const 111))
          (i32.store8 (i32.const 142) (i32.const 105))
          (i32.store8 (i32.const 143) (i32.const 110))
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (call $__str_gather (local.get $defaultJoined_ptr) (local.get $defaultJoined_len) (i32.const 146))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (local.get $defaultJoined_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 109))
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store8 (i32.const 139) (i32.const 74))
          ...
          (call $__str_gather (local.get $customJoined_ptr) (local.get $customJoined_len) (i32.const 145))
          (i32.store (i32.const 4) (i32.add (i32.const 13) (local.get $customJoined_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\41\72\72\61\79\20\6a\6f\69\6e\28\29\20\2d\2d\2d\0a")
  (data (i32.const 289) "\2c")
  (data (i32.const 290) "\20\2d\20")
)