(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 322))
  ...
  (func $isWeapon (param $item i32) (result i32)
    (return (i32.eq (i32.load (i32.add (local.get $item) (i32.const 0))) (i32.const 1)))
  )

  (func $isArmor (param $item i32) (result i32)
    (return (i32.eq (i32.load (i32.add (local.get $item) (i32.const 0))) (i32.const 2)))
  )

  (func $evaluateItem (param $item i32) (result i32)
    (if (call $isWeapon (local.get $item))
      (then
      (return (i32.load (i32.add (local.get $item) (i32.const 4))))
      )
      (else
      (if (call $isArmor (local.get $item))
        (then
        (return (i32.load (i32.add (local.get $item) (i32.const 4))))
        )
      )
  ...
  (func $testTypePredicateChains (export "testTypePredicateChains")  
    (local $w i32)
    (local $a i32)
    ...
    (local.set $a (i32.const 268))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 117))
          ...
          (i32.store8 (i32.const 142) (i32.const 87))
          ...
          (i32.store8 (i32.const 149) (i32.const 68))
          (i32.store8 (i32.const 150) (i32.const 97))
          (i32.store8 (i32.const 151) (i32.const 109))
          (i32.store8 (i32.const 152) (i32.const 97))
          (i32.store8 (i32.const 153) (i32.const 103))
          (i32.store8 (i32.const 154) (i32.const 101))
          (i32.store8 (i32.const 155) (i32.const 58))
          (i32.store8 (i32.const 156) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 25) (call $__i32_to_str (call $evaluateItem (local.get $w)) (i32.const 157))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 100))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store8 (i32.const 142) (i32.const 65))
          (i32.store8 (i32.const 143) (i32.const 114))
          (i32.store8 (i32.const 144) (i32.const 109))
          (i32.store8 (i32.const 145) (i32.const 111))
          (i32.store8 (i32.const 146) (i32.const 114))
          (i32.store8 (i32.const 147) (i32.const 32))
          (i32.store8 (i32.const 148) (i32.const 68))
          (i32.store8 (i32.const 149) (i32.const 101))
          (i32.store8 (i32.const 150) (i32.const 102))
          (i32.store8 (i32.const 151) (i32.const 101))
          (i32.store8 (i32.const 152) (i32.const 110))
          (i32.store8 (i32.const 153) (i32.const 115))
          (i32.store8 (i32.const 154) (i32.const 101))
          (i32.store8 (i32.const 155) (i32.const 58))
          (i32.store8 (i32.const 156) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 25) (call $__i32_to_str (call $evaluateItem (local.get $a)) (i32.const 157))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testTypePredicateChains )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 276) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\54\79\70\65\20\50\72\65\64\69\63\61\74\65\20\45\6c\73\65\2d\49\66\20\43\68\61\69\6e\73\20\2d\2d\2d\0a")
  (data (i32.const 260) "\01\00\00\00\96\00\00\00")
  (data (i32.const 268) "\02\00\00\00\4b\00\00\00")
)