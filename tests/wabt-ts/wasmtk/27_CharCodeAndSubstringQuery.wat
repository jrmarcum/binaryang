(module
  ...
  (func $testCharacterAccessAndQuery (export "testCharacterAccessAndQuery")  
    (local $word_ptr i32)
    (local $word_len i32)
    (local $firstCode i32)
    (local $firstChar_ptr i32)
    (local $firstChar_len i32)
    (local $starts i32)
    (local $ends i32)
    (local $falseEnds i32)
    ...
    (local $__str_op_len i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $word_ptr (i32.const 306))
      (local.set $word_len (i32.const 11))
    (local.set $firstCode (call $__str_char_code_at (local.get $word_ptr) (local.get $word_len) (i32.const 0)))
    (call $__str_char_at (local.get $word_ptr) (local.get $word_len) (i32.const 0))
      (local.set $firstChar_len)
      (local.set $firstChar_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 65))
          (i32.store8 (i32.const 133) (i32.const 83))
          (i32.store8 (i32.const 134) (i32.const 67))
          (i32.store8 (i32.const 135) (i32.const 73))
          (i32.store8 (i32.const 136) (i32.const 73))
          ...
          (i32.store8 (i32.const 143) (i32.const 48))
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (local.get $firstCode) (i32.const 146))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 104))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (call $__str_gather (local.get $firstChar_ptr) (local.get $firstChar_len) (i32.const 143))
          (i32.store (i32.const 4) (i32.add (i32.const 11) (local.get $firstChar_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $starts (call $__str_starts_with (local.get $word_ptr) (local.get $word_len) (i32.const 317) (i32.const 3)))
    (local.set $ends (call $__str_ends_with (local.get $word_ptr) (local.get $word_len) (i32.const 320) (i32.const 3)))
    (local.set $falseEnds (call $__str_ends_with (local.get $word_ptr) (local.get $word_len) (i32.const 323) (i32.const 3)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 139) (i32.const 87))
          (i32.store8 (i32.const 140) (i32.const 105))
          (i32.store8 (i32.const 141) (i32.const 116))
          (i32.store8 (i32.const 142) (i32.const 104))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store8 (i32.const 144) (i32.const 39))
          (i32.store8 (i32.const 145) (i32.const 87))
          (i32.store8 (i32.const 146) (i32.const 101))
          (i32.store8 (i32.const 147) (i32.const 98))
          (i32.store8 (i32.const 148) (i32.const 39))
          (i32.store8 (i32.const 149) (i32.const 58))
          (i32.store8 (i32.const 150) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (if (result i32) (local.get $starts) (then (i32.const 1)) (else (i32.const 0))) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 32))
          (i32.store8 (i32.const 137) (i32.const 87))
          ...
          (i32.store8 (i32.const 142) (i32.const 39))
          (i32.store8 (i32.const 143) (i32.const 98))
          (i32.store8 (i32.const 144) (i32.const 108))
          (i32.store8 (i32.const 145) (i32.const 121))
          (i32.store8 (i32.const 146) (i32.const 39))
          (i32.store8 (i32.const 147) (i32.const 58))
          (i32.store8 (i32.const 148) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__i32_to_str (if (result i32) (local.get $ends) (then (i32.const 1)) (else (i32.const 0))) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store8 (i32.const 142) (i32.const 39))
          (i32.store8 (i32.const 143) (i32.const 120))
          (i32.store8 (i32.const 144) (i32.const 121))
          (i32.store8 (i32.const 145) (i32.const 122))
          (i32.store8 (i32.const 146) (i32.const 39))
          (i32.store8 (i32.const 147) (i32.const 58))
          (i32.store8 (i32.const 148) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__i32_to_str (if (result i32) (local.get $falseEnds) (then (i32.const 1)) (else (i32.const 0))) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testCharacterAccessAndQuery )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\43\68\61\72\20\43\6f\64\65\20\26\20\53\75\62\73\74\72\69\6e\67\20\51\75\65\72\69\65\73\20\2d\2d\2d\0a")
  (data (i32.const 306) "\57\65\62\41\73\73\65\6d\62\6c\79")
  (data (i32.const 317) "\57\65\62")
  (data (i32.const 320) "\62\6c\79")
  (data (i32.const 323) "\78\79\7a")
)