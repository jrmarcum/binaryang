(module
  ...
  (global $PhysicsEngine_GRAVITY i32 (i32.const 9))
  ...
  (func $PhysicsEngine_calculateForce (param $mass i32) (result i32)
    (return (i32.mul (local.get $mass) (global.get $PhysicsEngine_GRAVITY)))
  )

  (func $testNamespaces (export "testNamespaces")  
    (local $force i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $force (call $PhysicsEngine_calculateForce (i32.const 10)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 141) (i32.const 82))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (global.get $PhysicsEngine_GRAVITY) (i32.const 147))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 70))
          (i32.store8 (i32.const 144) (i32.const 111))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 18) (call $__i32_to_str (local.get $force) (i32.const 150))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\4e\61\6d\65\73\70\61\63\65\73\20\2d\2d\2d\0a")
)