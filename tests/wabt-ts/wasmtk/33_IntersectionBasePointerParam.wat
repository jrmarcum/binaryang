(module
  ...
  (func $getScaleArea (param $t i32) (result f64)
    (return (f64.mul (f64.load (i32.add (local.get $t) (i32.const 0))) (f64.load (i32.add (local.get $t) (i32.const 8)))))
  )

  (func $testIntersectionParamPassing (export "testIntersectionParamPassing")  
    (local $hero i32)
    ...
    (;; 0.8;)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__f64_to_str (f64.load (i32.add (i32.const 260) (i32.const 16))) (i32.const 146))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 109))
          ...
          (i32.store8 (i32.const 145) (i32.const 97))
          (i32.store8 (i32.const 146) (i32.const 58))
          (i32.store8 (i32.const 147) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 16) (call $__f64_to_str (call $getScaleArea (local.get $hero)) (i32.const 148))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testIntersectionParamPassing )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 284) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\42\61\73\65\20\50\6f\69\6e\74\65\72\20\43\6f\6d\70\61\74\69\62\69\6c\69\74\79\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\00\40\00\00\00\00\00\00\08\40\9a\99\99\99\99\99\e9\3f")
)