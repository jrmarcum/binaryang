(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 337))
  ...
  (func $testStringSplitAndForOf (export "testStringSplitAndForOf")  
    (local $csvData_ptr i32)
    (local $csvData_len i32)
    (local $parts i32)
    (local $uppercaseConcat_ptr i32)
    (local $uppercaseConcat_len i32)
    (local $part_ptr i32)
    (local $part_len i32)
    ...
    (local $__str_op_len i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $csvData_ptr (i32.const 313))
      (local.set $csvData_len (i32.const 22))
    (local.set $parts (call $__str_split (local.get $csvData_ptr) (local.get $csvData_len) (i32.const 335) (i32.const 1)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 114))
          (i32.store8 (i32.const 141) (i32.const 97))
          (i32.store8 (i32.const 142) (i32.const 121))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store8 (i32.const 144) (i32.const 76))
          (i32.store8 (i32.const 145) (i32.const 101))
          (i32.store8 (i32.const 146) (i32.const 110))
          (i32.store8 (i32.const 147) (i32.const 103))
          (i32.store8 (i32.const 148) (i32.const 116))
          (i32.store8 (i32.const 149) (i32.const 104))
          (i32.store8 (i32.const 150) (i32.const 58))
          (i32.store8 (i32.const 151) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__i32_to_str (i32.load (local.get $parts)) (i32.const 152))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $uppercaseConcat_ptr (i32.const 336))
      (local.set $uppercaseConcat_len (i32.const 0))
    (local.set $__forof_idx (i32.const 0))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.ge_u (local.get $__forof_idx) (i32.load (local.get $parts))))
        (local.set $part_ptr (i32.load (i32.add (i32.add (local.get $parts) (i32.const 8)) (i32.shl (local.get $__forof_idx) (i32.const 3)))))
        (local.set $part_len (i32.load offset=4 (i32.add (i32.add (local.get $parts) (i32.const 8)) (i32.shl (local.get $__forof_idx) (i32.const 3)))))
        (block $cont_0
              (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 73))
          (i32.store8 (i32.const 133) (i32.const 116))
          (i32.store8 (i32.const 134) (i32.const 101))
          (i32.store8 (i32.const 135) (i32.const 109))
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (call $__str_gather (local.get $part_ptr) (local.get $part_len) (i32.const 138))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (local.get $part_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
          (local.set $uppercaseConcat_ptr (local.get $uppercaseConcat_ptr))
      (local.set $uppercaseConcat_len (local.get $uppercaseConcat_len))
      (call $__str_concat (local.get $uppercaseConcat_ptr) (local.get $uppercaseConcat_len) (call $__str_to_upper (local.get $part_ptr) (local.get $part_len)) )
      (local.set $uppercaseConcat_len)
      (local.set $uppercaseConcat_ptr)
      (call $__str_concat (local.get $uppercaseConcat_ptr) (local.get $uppercaseConcat_len) (i32.const 336) (i32.const 1))
      (local.set $uppercaseConcat_len)
      (local.set $uppercaseConcat_ptr)
        )
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 79))
          (i32.store8 (i32.const 143) (i32.const 117))
          (i32.store8 (i32.const 144) (i32.const 116))
          (i32.store8 (i32.const 145) (i32.const 112))
          (i32.store8 (i32.const 146) (i32.const 117))
          (i32.store8 (i32.const 147) (i32.const 116))
          (i32.store8 (i32.const 148) (i32.const 58))
          (i32.store8 (i32.const 149) (i32.const 32))
          (call $__str_gather (local.get $uppercaseConcat_ptr) (local.get $uppercaseConcat_len) (i32.const 150))
          (i32.store (i32.const 4) (i32.add (i32.const 18) (local.get $uppercaseConcat_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testStringSplitAndForOf )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\53\74\72\69\6e\67\20\53\70\6c\69\74\20\26\20\53\74\72\69\6e\67\20\41\72\72\61\79\20\66\6f\72\2e\2e\2e\6f\66\20\2d\2d\2d\0a")
  (data (i32.const 313) "\61\6c\70\68\61\2c\62\65\74\61\2c\67\61\6d\6d\61\2c\64\65\6c\74\61")
  (data (i32.const 335) "\2c")
  (data (i32.const 336) "")
  (data (i32.const 336) "\3a")
)