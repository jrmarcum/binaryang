(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 334))
  ...
  (func $extractAsFloat (param $container i32) (result f64)
    (if (i32.eq (i32.load (local.get $container)) (i32.const 0))
      (then
      (return (f64.load (i32.add (local.get $container) (i32.const 8))))
      )
      (else
      (if (i32.eq (i32.load (local.get $container)) (i32.const 1))
        (then
        (return (f64.load (i32.add (local.get $container) (i32.const 8))))
        )
      )
  ...
  (func $testElseIfNarrowing (export "testElseIfNarrowing")  
    (local $v1 i32)
    (local $v2 i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 292))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $v1 (i32.const 260))
    (local.set $v2 (i32.const 276))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 146) (i32.const 97))
          (i32.store8 (i32.const 147) (i32.const 115))
          (i32.store8 (i32.const 148) (i32.const 32))
          (i32.store8 (i32.const 149) (i32.const 70))
          (i32.store8 (i32.const 150) (i32.const 108))
          (i32.store8 (i32.const 151) (i32.const 111))
          (i32.store8 (i32.const 152) (i32.const 97))
          (i32.store8 (i32.const 153) (i32.const 116))
          (i32.store8 (i32.const 154) (i32.const 58))
          (i32.store8 (i32.const 155) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 24) (call $__f64_to_str (call $extractAsFloat (local.get $v1)) (i32.const 156))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 69))
          ...
          (i32.store8 (i32.const 151) (i32.const 70))
          (i32.store8 (i32.const 152) (i32.const 108))
          (i32.store8 (i32.const 153) (i32.const 111))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 26) (call $__f64_to_str (call $extractAsFloat (local.get $v2)) (i32.const 158))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    ...
    (call $testElseIfNarrowing )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 292) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\43\68\61\69\6e\65\64\20\65\6c\73\65\20\69\66\20\4e\61\72\72\6f\77\69\6e\67\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\59\40")
  (data (i32.const 276) "\01\00\00\00\00\00\00\00\00\00\00\00\00\80\39\40")
)