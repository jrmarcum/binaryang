(module
  ...
  (func $testPhase22Prep (export "testPhase22Prep")  
    (local $mask i32)
    (local $isWriteAllowed i32)
    (local $baseVal i32)
    (local $expVal f64)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $mask (i32.const 3))
    (local.set $isWriteAllowed (i32.eq (i32.and (local.get $mask) (i32.const 2)) (i32.const 2)))
    (local.set $baseVal (i32.const 2))
    (local.set $expVal (call $mathlib_pow (f64.convert_i32_s (local.get $baseVal)) (f64.const 3)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 65))
          ...
          (i32.store8 (i32.const 138) (i32.const 77))
          (i32.store8 (i32.const 139) (i32.const 97))
          (i32.store8 (i32.const 140) (i32.const 115))
          (i32.store8 (i32.const 141) (i32.const 107))
          (i32.store8 (i32.const 142) (i32.const 58))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (local.get $mask) (i32.const 144))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 87))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (if (result i32) (local.get $isWriteAllowed) (then (i32.const 1)) (else (i32.const 0))) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 69))
          ...
          (i32.store8 (i32.const 141) (i32.const 67))
          (i32.store8 (i32.const 142) (i32.const 97))
          (i32.store8 (i32.const 143) (i32.const 115))
          (i32.store8 (i32.const 144) (i32.const 116))
          (i32.store8 (i32.const 145) (i32.const 58))
          (i32.store8 (i32.const 146) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__f64_to_str (local.get $expVal) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testPhase22Prep )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\50\72\65\2d\50\68\61\73\65\20\32\33\3a\20\45\6e\75\6d\20\46\6f\6c\64\69\6e\67\20\26\20\43\61\73\74\73\20\2d\2d\2d\0a")
