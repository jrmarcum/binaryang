(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 338))
  ...
  (func $isSphere (param $g i32) (result i32)
    (return (i32.eq (i32.load (local.get $g)) (i32.const 0)))
  )

  (func $testDiscUnionPredicate (export "testDiscUnionPredicate")  
    (local $geom i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 292))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $geom (i32.const 260))
    (if (call $isSphere (local.get $geom))
      (then
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 83))
          (i32.store8 (i32.const 133) (i32.const 112))
          (i32.store8 (i32.const 134) (i32.const 104))
          ...
          (i32.store8 (i32.const 139) (i32.const 82))
          ...
          (i32.store8 (i32.const 146) (i32.const 69))
          (i32.store8 (i32.const 147) (i32.const 120))
          (i32.store8 (i32.const 148) (i32.const 116))
          (i32.store8 (i32.const 149) (i32.const 114))
          (i32.store8 (i32.const 150) (i32.const 97))
          (i32.store8 (i32.const 151) (i32.const 99))
          (i32.store8 (i32.const 152) (i32.const 116))
          (i32.store8 (i32.const 153) (i32.const 101))
          (i32.store8 (i32.const 154) (i32.const 100))
          (i32.store8 (i32.const 155) (i32.const 58))
          (i32.store8 (i32.const 156) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 25) (call $__f64_to_str (f64.load (i32.add (i32.const 260) (i32.const 8))) (i32.const 157))))
  ...
  (func $_start (export "_start")
    ...
    (call $testDiscUnionPredicate )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 292) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\44\69\73\63\72\69\6d\69\6e\61\74\65\64\20\55\6e\69\6f\6e\20\50\72\65\64\69\63\61\74\65\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\24\40\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)