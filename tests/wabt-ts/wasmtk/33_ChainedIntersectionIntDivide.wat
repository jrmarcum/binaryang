(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 323))
  ...
  (func $calculateDensity (param $box i32) (result i32)
    (local $volume i32)
    (local.set $volume (i32.mul (i32.load (i32.add (local.get $box) (i32.const 4))) (i32.load (i32.add (local.get $box) (i32.const 8)))))
    (return (i32.div_s (i32.load (i32.add (local.get $box) (i32.const 12))) (local.get $volume)))
  )

  (func $testChainedIntersection (export "testChainedIntersection")  
    (local $box i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 276))
          (i32.store (i32.const 4) (i32.const 47))
          (drop (call $fd_write
            (i32.const 1)
            (i32.const 0)
            (i32.const 1)
            (i32.const 128)))
    (local.set $box (i32.const 260))
    (;; 99,;)
    (;; 2,;)
    (;; 5,;)
    (;; 100;)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 120))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store8 (i32.const 136) (i32.const 67))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 142))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 141) (i32.const 100))
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 68))
          (i32.store8 (i32.const 144) (i32.const 101))
          (i32.store8 (i32.const 145) (i32.const 110))
          (i32.store8 (i32.const 146) (i32.const 115))
          (i32.store8 (i32.const 147) (i32.const 105))
          (i32.store8 (i32.const 148) (i32.const 116))
          (i32.store8 (i32.const 149) (i32.const 121))
          (i32.store8 (i32.const 150) (i32.const 58))
          (i32.store8 (i32.const 151) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__i32_to_str (call $calculateDensity (local.get $box)) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testChainedIntersection )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 276) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\43\68\61\69\6e\65\64\20\4d\75\6c\74\69\2d\57\61\79\20\49\6e\74\65\72\73\65\63\74\69\6f\6e\20\2d\2d\2d\0a")
  (data (i32.const 260) "\63\00\00\00\02\00\00\00\05\00\00\00\64\00\00\00")
)