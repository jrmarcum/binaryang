(module
  ...
  (func $createVector (param $x i32) (param $y i32) (result i32)
    (local $__obj_ret i32)
    (local $__nested_ptr i32)
    (local.set $__obj_ret (call $__malloc (i32.const 8)))
      (i32.store offset=0 (local.get $__obj_ret) (local.get $x))
      (i32.store offset=4 (local.get $__obj_ret) (local.get $y))
      (return (local.get $__obj_ret))
  )

  (func $testShorthandProperties (export "testShorthandProperties")  
    (local $vec i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $vec (call $createVector (i32.const 40) (i32.const 60)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 86))
          ...
          (i32.store8 (i32.const 139) (i32.const 88))
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.load (i32.add (local.get $vec) (i32.const 0))) (i32.const 142))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 114))
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store8 (i32.const 139) (i32.const 89))
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.load (i32.add (local.get $vec) (i32.const 4))) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testShorthandProperties )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\53\68\6f\72\74\68\61\6e\64\20\50\72\6f\70\65\72\74\69\65\73\20\2d\2d\2d\0a")
)