(module
  ...
  (global $CounterNode_totalInstances (mut i32) (i32.const 0))
  ...
  (func $CounterNode_constructor (param $__self i32) (param $id i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 0)) (local.get $id))
    (global.set $CounterNode_totalInstances (i32.add (global.get $CounterNode_totalInstances) (i32.const 1)))
  )

  (func $CounterNode_getCount  (result i32)
    (return (global.get $CounterNode_totalInstances))
  )

  (func $testStaticFields (export "testStaticFields")  
    (local $n1 i32)
    (local $n2 i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 268))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 22) (call $__i32_to_str (call $CounterNode_getCount ) (i32.const 154))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $n1 (i32.const 260))
      (call $CounterNode_constructor (i32.const 260) (i32.const 101))
    (local.set $n2 (i32.const 264))
      (call $CounterNode_constructor (i32.const 264) (i32.const 102))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 146) (i32.const 70))
          ...
          (i32.store8 (i32.const 152) (i32.const 65))
          (i32.store8 (i32.const 153) (i32.const 99))
          (i32.store8 (i32.const 154) (i32.const 99))
          (i32.store8 (i32.const 155) (i32.const 101))
          (i32.store8 (i32.const 156) (i32.const 115))
          (i32.store8 (i32.const 157) (i32.const 115))
          (i32.store8 (i32.const 158) (i32.const 58))
          (i32.store8 (i32.const 159) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 28) (call $__i32_to_str (global.get $CounterNode_totalInstances) (i32.const 160))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testStaticFields )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 268) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\53\74\61\74\69\63\20\46\69\65\6c\64\73\20\26\20\47\6c\6f\62\61\6c\73\20\2d\2d\2d\0a")
