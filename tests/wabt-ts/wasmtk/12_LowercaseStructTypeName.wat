(module
  ...
  (func $vec_dot (param $a i32) (param $b i32) (result f64)
    (return (f64.add (f64.mul (f64.load (i32.add (local.get $a) (i32.const 0))) (f64.load (i32.add (local.get $b) (i32.const 0)))) (f64.mul (f64.load (i32.add (local.get $a) (i32.const 8))) (f64.load (i32.add (local.get $b) (i32.const 8))))))
  )

  (func $vec_lengthSq (param $v i32) (result f64)
    (return (f64.add (f64.mul (f64.load (i32.add (local.get $v) (i32.const 0))) (f64.load (i32.add (local.get $v) (i32.const 0)))) (f64.mul (f64.load (i32.add (local.get $v) (i32.const 8))) (f64.load (i32.add (local.get $v) (i32.const 8))))))
  )

  (func $tagWeight (param $t i32) (result f64)
    (return (f64.load (i32.add (local.get $t) (i32.const 8))))
  )

  (func $testLowercaseStructNames (export "testLowercaseStructNames")  
    (local $a i32)
    (local $b i32)
    (local $t i32)
    (local $c i32)
    ...
    (local.set $b (i32.const 276))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 103))
          (i32.store8 (i32.const 136) (i32.const 116))
          (i32.store8 (i32.const 137) (i32.const 104))
          (i32.store8 (i32.const 138) (i32.const 83))
          (i32.store8 (i32.const 139) (i32.const 113))
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__f64_to_str (call $vec_lengthSq (local.get $a)) (i32.const 142))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__f64_to_str (call $vec_dot (local.get $a) (local.get $b)) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $t (i32.const 292))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 4) (call $__i32_to_str (i32.load (i32.add (i32.const 292) (i32.const 0))) (i32.const 136))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 103))
          (i32.store8 (i32.const 136) (i32.const 104))
          (i32.store8 (i32.const 137) (i32.const 116))
          (i32.store8 (i32.const 138) (i32.const 58))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__f64_to_str (call $tagWeight (local.get $t)) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (f64.store (i32.add (i32.const 292) (i32.const 8)) (f64.const 2.5))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 119))
          (i32.store8 (i32.const 133) (i32.const 101))
          ...
          (i32.store8 (i32.const 145) (i32.const 119))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__f64_to_str (f64.load (i32.add (i32.const 292) (i32.const 8))) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $c (i32.const 308))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 7) (call $__f64_to_str (call $vec_dot (local.get $a) (local.get $c)) (i32.const 139))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 292) "\07\00\00\00\00\00\00\00\00\00\00\00\00\00\f8\3f")
  (data (i32.const 308) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\14\40")
)