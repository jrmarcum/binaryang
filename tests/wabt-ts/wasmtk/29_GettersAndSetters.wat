(module
  ...
  (func $TemperatureSensor_constructor (param $__self i32) (param $celsius i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 0)) (local.get $celsius))
  )

  (func $TemperatureSensor_get_fahrenheit (param $__self i32) (result i32)
    (return (i32.add (i32.div_s (i32.mul (i32.load (i32.add (local.get $__self) (i32.const 0))) (i32.const 9)) (i32.const 5)) (i32.const 32)))
  )

  (func $TemperatureSensor_set_fahrenheit (param $__self i32) (param $f i32) 
    (i32.store (i32.add (local.get $__self) (i32.const 0)) (i32.div_s (i32.mul (i32.sub (local.get $f) (i32.const 32)) (i32.const 5)) (i32.const 9)))
  )

  (func $TemperatureSensor_get_celsius (param $__self i32) (result i32)
    (return (i32.load (i32.add (local.get $__self) (i32.const 0))))
  )

  (func $testGettersAndSetters (export "testGettersAndSetters")  
    (local $sensor i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 264))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $sensor (i32.const 260))
      (call $TemperatureSensor_constructor (i32.const 260) (i32.const 0))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 67))
          ...
          (i32.store8 (i32.const 145) (i32.const 117))
          (i32.store8 (i32.const 146) (i32.const 115))
          (i32.store8 (i32.const 147) (i32.const 58))
          (i32.store8 (i32.const 148) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__i32_to_str (call $TemperatureSensor_get_celsius (i32.const 260)) (i32.const 149))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 148) (i32.const 105))
          (i32.store8 (i32.const 149) (i32.const 116))
          (i32.store8 (i32.const 150) (i32.const 58))
          (i32.store8 (i32.const 151) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__i32_to_str (call $TemperatureSensor_get_fahrenheit (i32.const 260)) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $TemperatureSensor_set_fahrenheit (i32.const 260) (i32.const 212))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
  ...
  (func $_start (export "_start")
    (call $testGettersAndSetters )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 264) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\47\65\74\74\65\72\73\20\61\6e\64\20\53\65\74\74\65\72\73\20\2d\2d\2d\0a")
