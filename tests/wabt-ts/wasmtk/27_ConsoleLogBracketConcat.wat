(module
  ...
  (func $testBracketConcat (export "testBracketConcat")  
    (local $w_ptr i32)
    (local $w_len i32)
    (local $nums i32)
    (local $__iface_tmp i32)
    (local.set $w_ptr (i32.const 260))
      (local.set $w_len (i32.const 1))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (local.get $w_ptr) (local.get $w_len) (i32.const 140))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (local.get $w_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 98))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 141) (i32.const 91))
          (call $__str_gather (local.get $w_ptr) (local.get $w_len) (i32.const 142))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (local.get $w_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 58))
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store8 (i32.const 139) (i32.const 123))
          (call $__str_gather (local.get $w_ptr) (local.get $w_len) (i32.const 140))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (local.get $w_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 91))
          (call $__str_gather (local.get $w_ptr) (local.get $w_len) (i32.const 144))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (local.get $w_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 91))
          (i32.store8 (i32.const 141) (i32.const 40))
          (call $__str_gather (local.get $w_ptr) (local.get $w_len) (i32.const 142))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (local.get $w_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 41))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 93))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 10))
    ...
    (local.set $nums (call $__malloc (i32.const 40)))
      ...
      (i32.store offset=8 (local.get $nums) (i32.const 7))
      (i32.store offset=12 (local.get $nums) (i32.const 8))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 148) (i32.const 58))
          (i32.store8 (i32.const 149) (i32.const 32))
          (call $__str_gather (local.get $w_ptr) (local.get $w_len) (i32.const 150))
          (i32.store (i32.const 4) (i32.add (i32.const 18) (local.get $w_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 91))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 93))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 3)))
          (drop (call $fd_write
  ...
  (func $_start (export "_start")
    (call $testBracketConcat )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\56")
  (data (i32.const 261) "\2c")
)