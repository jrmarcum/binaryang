(module
  ...
  (func $usePartial (param $p i32) (result f64)
    (return (f64.add (f64.load (i32.add (local.get $p) (i32.const 0))) (f64.load (i32.add (local.get $p) (i32.const 8)))))
  )

  (func $useReadonly (param $c i32) (result i32)
    (return (i32.add (i32.add (i32.load (i32.add (local.get $c) (i32.const 0))) (i32.load (i32.add (local.get $c) (i32.const 4)))) (i32.load (i32.add (local.get $c) (i32.const 8)))))
  )

  (func $useFlat (param $f i32) (result i32)
    (return (i32.mul (i32.load (i32.add (local.get $f) (i32.const 0))) (i32.load (i32.add (local.get $f) (i32.const 4)))))
  )

  (func $combine (param $a i32) (param $b f64) (result f64)
    (return (f64.add (f64.convert_i32_s (local.get $a)) (local.get $b)))
  )

  (func $makeVal  (result f64)
    (return (f64.const 3.5))
  )
  ...
  (func $main  
    ...
    (local $rt f64)
    (local $args i32)
    (local $inlineArgs i32)
    (local $__iface_tmp i32)
    (local.set $a (i32.const 260))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__f64_to_str (call $usePartial (local.get $a)) (i32.const 141))))
    ...
    (local.set $b (i32.const 276))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (call $useReadonly (local.get $b)) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $r (i32.const 288))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 114))
          (i32.store8 (i32.const 133) (i32.const 101))
          (i32.store8 (i32.const 134) (i32.const 113))
          ...
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__f64_to_str (f64.add (f64.load (i32.add (i32.const 288) (i32.const 0))) (f64.load (i32.add (i32.const 288) (i32.const 8)))) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $n (i32.const 42))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 58))
          (i32.store8 (i32.const 140) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (local.get $n) (i32.const 141))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $px (i32.const 304))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 46))
          (i32.store8 (i32.const 137) (i32.const 120))
          (i32.store8 (i32.const 138) (i32.const 58))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__f64_to_str (f64.load (i32.add (i32.const 304) (i32.const 0))) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $o (i32.const 320))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (i32.add (i32.load (i32.add (i32.const 320) (i32.const 0))) (i32.load (i32.add (i32.const 320) (i32.const 4)))) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $rec (i32.const 332))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 58))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (i32.add (i32.load (i32.add (i32.const 332) (i32.const 0))) (i32.load (i32.add (i32.const 332) (i32.const 4)))) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $flatVal (i32.const 340))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__i32_to_str (call $useFlat (local.get $flatVal)) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $rt (call $combine (i32.const 2) (f64.const 1.5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 114))
          (i32.store8 (i32.const 133) (i32.const 101))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__f64_to_str (local.get $rt) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (call $__f64_to_str (call $makeVal) (i32.const 138))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $args (i32.const 352))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 58))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (i32.load (i32.add (i32.const 352) (i32.const 0))) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__f64_to_str (f64.load (i32.add (i32.const 352) (i32.const 8))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $inlineArgs (i32.const 368))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 112))
          (i32.store8 (i32.const 133) (i32.const 97))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (i32.load (i32.add (i32.const 368) (i32.const 0))) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__f64_to_str (f64.load (i32.add (i32.const 368) (i32.const 8))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\00\00\00\00\00\00\08\40\00\00\00\00\00\00\10\40")
  (data (i32.const 276) "\01\00\00\00\02\00\00\00\03\00\00\00")
  (data (i32.const 288) "\00\00\00\00\00\00\f8\3f\00\00\00\00\00\00\04\40")
  (data (i32.const 304) "\00\00\00\00\00\00\22\40\00\00\00\00\00\00\00\00")
  (data (i32.const 320) "\0a\00\00\00\14\00\00\00\00\00\00\00")
  (data (i32.const 332) "\05\00\00\00\07\00\00\00")
  (data (i32.const 340) "\04\00\00\00\06\00\00\00\00\00\00\00")
  (data (i32.const 352) "\07\00\00\00\00\00\00\00\00\00\00\00\00\00\04\40")
  (data (i32.const 368) "\09\00\00\00\00\00\00\00\00\00\00\00\00\00\f0\3f")
)