(module
  ...
  (func $sumBase (param $b i32) (result i32)
    (return (i32.add (i32.load (i32.add (local.get $b) (i32.const 0))) (i32.load (i32.add (local.get $b) (i32.const 4)))))
  )

  (func $scaleExtra (param $w i32) (result f64)
    (return (f64.mul (f64.load (i32.add (local.get $w) (i32.const 8))) (f64.const 2.0)))
  )

  (func $allFields (param $a i32) (result i32)
    (return (i32.add (i32.add (i32.load (i32.add (local.get $a) (i32.const 0))) (i32.load (i32.add (local.get $a) (i32.const 4)))) (i32.load (i32.add (local.get $a) (i32.const 16)))))
  )
  (func $_start (export "_start")
    (local $two i32)
    (local $three i32)
    (local $__iface_tmp i32)
    (local.set $two (i32.const 260))
    (local.set $three (i32.const 276))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 16) (call $__i32_to_str (call $sumBase (local.get $three)) (i32.const 148))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 120))
          ...
          (i32.store8 (i32.const 146) (i32.const 41))
          (i32.store8 (i32.const 147) (i32.const 58))
          (i32.store8 (i32.const 148) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__f64_to_str (call $scaleExtra (local.get $two)) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 40))
          (i32.store8 (i32.const 143) (i32.const 116))
          (i32.store8 (i32.const 144) (i32.const 104))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__f64_to_str (call $scaleExtra (local.get $three)) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 135) (i32.const 70))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 18) (call $__i32_to_str (call $allFields (local.get $three)) (i32.const 150))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\03\00\00\00\04\00\00\00\00\00\00\00\00\00\f8\3f")
  (data (i32.const 276) "\0a\00\00\00\14\00\00\00\00\00\00\00\00\00\04\40\07\00\00\00")
)