(module
  ...
  (func $processPoint (param $pt i32) (result f64)
    (return (f64.add (f64.add (f64.add (f64.load (i32.add (local.get $pt) (i32.const 0))) (f64.load (i32.add (local.get $pt) (i32.const 8)))) (f64.load (i32.add (local.get $pt) (i32.const 16)))) (f64.convert_i32_s (i32.load (i32.add (local.get $pt) (i32.const 24))))))
  )

  (func $testInterfaceInheritance (export "testInterfaceInheritance")  
    (local $point i32)
    ...
    (;; 10,;)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 73))
          (i32.store8 (i32.const 139) (i32.const 68))
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 24))) (i32.const 142))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 141) (i32.const 83))
          (i32.store8 (i32.const 142) (i32.const 117))
          (i32.store8 (i32.const 143) (i32.const 109))
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__f64_to_str (call $processPoint (local.get $point)) (i32.const 146))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testInterfaceInheritance )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 288) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\49\6e\74\65\72\66\61\63\65\20\49\6e\68\65\72\69\74\61\6e\63\65\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\f8\3f\00\00\00\00\00\00\04\40\00\00\00\00\00\00\08\40\0a\00\00\00")
)