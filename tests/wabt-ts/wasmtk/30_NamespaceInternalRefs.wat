(module
  ...
  (global $Cfg_LIMIT i32 (i32.const 5))
  (global $Cfg_STEP i32 (i32.const 2))
  ...
  (func $Cfg_scale (param $v i32) (result i32)
    (return (i32.mul (local.get $v) (global.get $Cfg_LIMIT)))
  )

  (func $Cfg_scaleTwice (param $v i32) (result i32)
    (return (i32.add (call $Cfg_scale (local.get $v)) (global.get $Cfg_STEP)))
  )

  (func $Cfg_describe  (result i32)
    (local $note_ptr i32)
    (local $note_len i32)
    (local.set $note_ptr (i32.const 260))
      (local.set $note_len (i32.const 34))
    (return (local.get $note_len))
  )

  (func $testNamespaceInternalRefs (export "testNamespaceInternalRefs")  
    (local $h i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 298))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 118))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (global.get $Cfg_LIMIT) (i32.const 146))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 149) (i32.const 102))
          (i32.store8 (i32.const 150) (i32.const 110))
          (i32.store8 (i32.const 151) (i32.const 58))
          (i32.store8 (i32.const 152) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 21) (call $__i32_to_str (call $Cfg_scale (i32.const 3)) (i32.const 153))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 99))
          (i32.store8 (i32.const 144) (i32.const 97))
          (i32.store8 (i32.const 145) (i32.const 108))
          (i32.store8 (i32.const 146) (i32.const 108))
          (i32.store8 (i32.const 147) (i32.const 58))
          (i32.store8 (i32.const 148) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__i32_to_str (call $Cfg_scaleTwice (i32.const 3)) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 117))
          (i32.store8 (i32.const 145) (i32.const 99))
          (i32.store8 (i32.const 146) (i32.const 104))
          (i32.store8 (i32.const 147) (i32.const 101))
          (i32.store8 (i32.const 148) (i32.const 100))
          (i32.store8 (i32.const 149) (i32.const 58))
          (i32.store8 (i32.const 150) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (call $Cfg_describe) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $h (i32.const 294))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (i32.load (i32.add (i32.const 294) (i32.const 0))) (i32.const 146))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testNamespaceInternalRefs )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\4c\49\4d\49\54\20\61\6e\64\20\53\54\45\50\20\61\72\65\20\6a\75\73\74\20\77\6f\72\64\73\20\68\65\72\65")
  (data (i32.const 298) "\2d\2d\2d\20\4e\61\6d\65\73\70\61\63\65\20\69\6e\74\65\72\6e\61\6c\20\72\65\66\65\72\65\6e\63\65\73\20\2d\2d\2d\0a")
  (data (i32.const 294) "\63\00\00\00")
)