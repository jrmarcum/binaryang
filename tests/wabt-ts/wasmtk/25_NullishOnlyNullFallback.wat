(module
  ...
  (func $getNullableValue (param $kind i32) (result i32)
  ...
  (func $testNullishCoalescing (export "testNullishCoalescing")  
    (local $nullVal i32)
    (local $nullVal__null i32)
    (local $zeroVal i32)
    (local $zeroVal__null i32)
    (local $realVal i32)
    (local $realVal__null i32)
    (local $res1 i32)
    (local $res2 i32)
    (local $res3 i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $nullVal (call $getNullableValue (i32.const 0)))
      (local.set $nullVal__null (i32.eqz (global.get $__nullable_ret_flag)))
    (local.set $zeroVal (call $getNullableValue (i32.const 1)))
      (local.set $zeroVal__null (i32.eqz (global.get $__nullable_ret_flag)))
    (local.set $realVal (call $getNullableValue (i32.const 2)))
      (local.set $realVal__null (i32.eqz (global.get $__nullable_ret_flag)))
    (local.set $res1 (if (result i32) (local.get $nullVal__null) (then (i32.const 999)) (else (local.get $nullVal))))
    (local.set $res2 (if (result i32) (local.get $zeroVal__null) (then (i32.const 999)) (else (local.get $zeroVal))))
    (local.set $res3 (if (result i32) (local.get $realVal__null) (then (i32.const 999)) (else (local.get $realVal))))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 70))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (local.get $res1) (i32.const 147))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 90))
          ...
          (i32.store8 (i32.const 145) (i32.const 58))
          (i32.store8 (i32.const 146) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (local.get $res2) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 145) (i32.const 58))
          (i32.store8 (i32.const 146) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (local.get $res3) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testNullishCoalescing )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\4e\75\6c\6c\69\73\68\20\43\6f\61\6c\65\73\63\69\6e\67\20\53\65\6d\61\6e\74\69\63\73\20\2d\2d\2d\0a")
)