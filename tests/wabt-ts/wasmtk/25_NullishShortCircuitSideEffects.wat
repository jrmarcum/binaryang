(module
  ...
  (global $sideEffectCount (mut i32) (i32.const 0))
  ...
  (func $computeValue  (result i32)
    (global.set $sideEffectCount (i32.add (global.get $sideEffectCount) (i32.const 1)))
    (return (i32.const 500))
  )

  (func $testShortCircuiting (export "testShortCircuiting")  
    (local $activeValue i32)
    (local $activeValue__null i32)
    (local $missingValue i32)
    (local $missingValue__null i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $activeValue (i32.const 100))
      (local.set $activeValue__null (i32.const 0))
    (if (local.get $activeValue__null) (then (local.set $activeValue (call $computeValue )) (local.set $activeValue__null (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 86))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (local.get $activeValue) (i32.const 146))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 67))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (global.get $sideEffectCount) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $missingValue__null (i32.const 1))
    (if (local.get $missingValue__null) (then (local.set $missingValue (call $computeValue )) (local.set $missingValue__null (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 140) (i32.const 86))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (local.get $missingValue) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testShortCircuiting )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\53\68\6f\72\74\2d\43\69\72\63\75\69\74\20\53\69\64\65\20\45\66\66\65\63\74\73\20\2d\2d\2d\0a")
)