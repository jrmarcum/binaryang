(module
  ...
  (func $_start (export "_start")
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.ge_u (local.get $__forof_idx) (i32.const 3)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $dyn (call $__malloc (i32.const 40)))
      (i32.store (local.get $dyn) (i32.const 4))
      (i32.store offset=4 (local.get $dyn) (i32.const 8))
      (i32.store offset=8 (local.get $dyn) (i32.const 1))
      (i32.store offset=12 (local.get $dyn) (i32.const 2))
      (i32.store offset=16 (local.get $dyn) (i32.const 3))
      (i32.store offset=20 (local.get $dyn) (i32.const 4))
    (local.set $dyn (call $__dynarr_push_i32 (local.get $dyn) (i32.const 5)))
    (local.set $__forof_idx (i32.const 0))
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.ge_u (local.get $__forof_idx) (i32.load (local.get $dyn))))
        (local.set $x (i32.load (i32.add (i32.add (local.get $dyn) (i32.const 8)) (i32.shl (local.get $__forof_idx) (i32.const 2)))))
        (block $cont_1
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (global.get $count) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
