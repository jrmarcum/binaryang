(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 307))
  ...
  (func $getTupleValue (param $flag i32) (result i32)
    (local $__obj_ret i32)
    ...
    (global.set $__nullable_ret_flag (i32.const 1))
      ...
      (i32.store offset=0 (local.get $__obj_ret) (i32.const 100))
      (f64.store offset=8 (local.get $__obj_ret) (f64.const 3.14159))
      (return (local.get $__obj_ret))
  )

  (func $testPhase24Post (export "testPhase24Post")  
    (local $nullResult i32)
    (local $validResult i32)
    (local $val i32)
    (local $ratio f64)
    ...
    (local $__str_op_len i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $nullResult (call $getTupleValue (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 67))
          (i32.store8 (i32.const 138) (i32.const 104))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (if (result i32) (i32.eq (local.get $nullResult) (i32.const 0)) (then (i32.const 1)) (else (i32.const 0))) (i32.const 144))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $validResult (call $getTupleValue (i32.const 1)))
    (if (i32.ne (local.get $validResult) (i32.const 0))
      (then
      (local.set $val (i32.load (i32.add (local.get $validResult) (i32.const 0))))
      (local.set $ratio (f64.load (i32.add (local.get $validResult) (i32.const 8))))
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 142) (i32.const 73))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (if (result i32) (i32.eqz (local.get $val)) (then (i32.const -1)) (else (local.get $val))) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
          ...
          (i32.store8 (i32.const 140) (i32.const 100))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store8 (i32.const 142) (i32.const 70))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__f64_to_str (local.get $ratio) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testPhase24Post )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\50\6f\73\74\2d\50\68\61\73\65\20\32\33\3a\20\4e\75\6c\6c\61\62\6c\65\20\54\75\70\6c\65\73\20\26\20\46\6c\61\67\73\20\2d\2d\2d\0a")
)