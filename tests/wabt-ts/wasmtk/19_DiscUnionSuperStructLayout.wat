(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 417))
  ...
  (func $testDiscUnionLayout (export "testDiscUnionLayout")  
    (local $c i32)
    (local $r i32)
    (local $p i32)
    ...
    (local.set $r (i32.const 296))
    (local.set $p (i32.const 332))
    (if (i32.eq (i32.load (i32.const 260)) (i32.const 0))
      (then
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__f64_to_str (f64.load (i32.add (i32.const 260) (i32.const 8))) (i32.const 147))))
    ...
    (if (i32.eq (i32.load (i32.const 296)) (i32.const 1))
      (then
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 16) (call $__f64_to_str (f64.mul (f64.load (i32.add (i32.const 296) (i32.const 16))) (f64.load (i32.add (i32.const 296) (i32.const 24)))) (i32.const 148))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (if (i32.eq (i32.load (i32.const 332)) (i32.const 2))
      (then
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (i32.load (i32.add (i32.const 332) (i32.const 32))) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    ...
    (;; | { kind: "point"; id: i32 };;)
    (call $testDiscUnionLayout )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 368) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\44\69\73\63\72\69\6d\69\6e\61\74\65\64\20\55\6e\69\6f\6e\20\53\75\70\65\72\2d\53\74\72\75\63\74\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\14\40\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 296) "\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\10\40\00\00\00\00\00\00\24\40\00\00\00\00")
  (data (i32.const 332) "\02\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\2a\00\00\00")
)