(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 384))
  ...
  (func $testTrim  
    ...
    (local.set $s_ptr (i32.const 260))
      (local.set $s_len (i32.const 15))
    (call $__str_trim (local.get $s_ptr) (local.get $s_len))
      (local.set $trimmed_len)
      (local.set $trimmed_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $trimmed_ptr) (local.get $trimmed_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $trimmed_len)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $s2_ptr (i32.const 275))
      (local.set $s2_len (i32.const 9))
    (call $__str_trim_start (local.get $s2_ptr) (local.get $s2_len))
      (local.set $ts_len)
      (local.set $ts_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $ts_ptr) (local.get $ts_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $ts_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $s3_ptr (i32.const 284))
      (local.set $s3_len (i32.const 10))
    (call $__str_trim_end (local.get $s3_ptr) (local.get $s3_len))
      (local.set $te_len)
      (local.set $te_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $te_ptr) (local.get $te_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $te_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $testCharCodeAt  
    ...
    (local $code3 i32)
    (local $__iface_tmp i32)
    (local.set $s_ptr (i32.const 294))
      (local.set $s_len (i32.const 3))
    (local.set $code (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $code) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $code2 (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (i32.const 1)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $code2) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $code3 (call $__str_char_code_at (local.get $s_ptr) (local.get $s_len) (i32.const 2)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $code3) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $testCharAt  
    ...
    (call $__str_char_at (local.get $s_ptr) (local.get $s_len) (i32.const 1))
      ...
      (local.set $c_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $c_ptr) (local.get $c_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $c_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $__str_char_at (local.get $s_ptr) (local.get $s_len) (i32.const 4))
      (local.set $c2_len)
      (local.set $c2_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $c2_ptr) (local.get $c2_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $c2_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $testStartsEndsWith  
    ...
    (local $ew2 i32)
    (local $__iface_tmp i32)
    (local.set $s_ptr (i32.const 302))
      (local.set $s_len (i32.const 11))
    (local.set $sw1 (call $__str_starts_with (local.get $s_ptr) (local.get $s_len) (i32.const 297) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (if (result i32) (local.get $sw1) (then (i32.const 313)) (else (i32.const 317))) (if (result i32) (local.get $sw1) (then (i32.const 4)) (else (i32.const 5))) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (if (result i32) (local.get $sw1) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $sw2 (call $__str_starts_with (local.get $s_ptr) (local.get $s_len) (i32.const 322) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (if (result i32) (local.get $sw2) (then (i32.const 313)) (else (i32.const 317))) (if (result i32) (local.get $sw2) (then (i32.const 4)) (else (i32.const 5))) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (if (result i32) (local.get $sw2) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $ew1 (call $__str_ends_with (local.get $s_ptr) (local.get $s_len) (i32.const 322) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (if (result i32) (local.get $ew1) (then (i32.const 313)) (else (i32.const 317))) (if (result i32) (local.get $ew1) (then (i32.const 4)) (else (i32.const 5))) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (if (result i32) (local.get $ew1) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $ew2 (call $__str_ends_with (local.get $s_ptr) (local.get $s_len) (i32.const 297) (i32.const 5)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (if (result i32) (local.get $ew2) (then (i32.const 313)) (else (i32.const 317))) (if (result i32) (local.get $ew2) (then (i32.const 4)) (else (i32.const 5))) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (if (result i32) (local.get $ew2) (then (i32.const 4)) (else (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $testCaseConversion  
    ...
    (call $__str_to_upper (local.get $s_ptr) (local.get $s_len))
      ...
      (local.set $up_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $up_ptr) (local.get $up_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $up_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (call $__str_to_lower (local.get $s_ptr) (local.get $s_len))
      ...
      (local.set $lo_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $lo_ptr) (local.get $lo_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $lo_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $testReplace  
    ...
    (local $r2_len i32)
    (local $__iface_tmp i32)
    (local.set $s_ptr (i32.const 338))
      (local.set $s_len (i32.const 11))
    (call $__str_replace (local.get $s_ptr) (local.get $s_len) (i32.const 349) (i32.const 3) (i32.const 352) (i32.const 3))
      (local.set $r1_len)
      (local.set $r1_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $r1_ptr) (local.get $r1_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $r1_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $__str_replace_all (local.get $s_ptr) (local.get $s_len) (i32.const 349) (i32.const 3) (i32.const 352) (i32.const 3))
      (local.set $r2_len)
      (local.set $r2_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $r2_ptr) (local.get $r2_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $r2_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $testPad  
    ...
    (local $__str_op_ptr i32)
    (local $__str_op_len i32)
    (local.set $s_ptr (i32.const 355))
      (local.set $s_len (i32.const 2))
    (call $__str_pad_start (local.get $s_ptr) (local.get $s_len) (i32.const 5) (i32.const 357) (i32.const 1))
      (local.set $ps_len)
      (local.set $ps_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $ps_ptr) (local.get $ps_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $ps_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $__str_pad_end (local.get $s_ptr) (local.get $s_len) (i32.const 5) (i32.const 358) (i32.const 1))
      (local.set $pe_len)
      (local.set $pe_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $pe_ptr) (local.get $pe_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $pe_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $testRepeat  
    ...
    (local $r2_len i32)
    (local $__iface_tmp i32)
    (local.set $s_ptr (i32.const 359))
      (local.set $s_len (i32.const 2))
    (call $__str_repeat (local.get $s_ptr) (local.get $s_len) (i32.const 3))
      (local.set $r_len)
      (local.set $r_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $r_ptr) (local.get $r_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $r_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $s2_ptr (i32.const 361))
      (local.set $s2_len (i32.const 1))
    (call $__str_repeat (local.get $s2_ptr) (local.get $s2_len) (i32.const 1))
      (local.set $r2_len)
      (local.set $r2_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
  ...
  (func $testSplit  
    ...
    (local $__str_op_ptr i32)
    (local $__str_op_len i32)
    (local.set $s_ptr (i32.const 362))
      (local.set $s_len (i32.const 5))
    (local.set $parts (call $__str_split (local.get $s_ptr) (local.get $s_len) (i32.const 367) (i32.const 1)))
    (local.set $count (i32.load (local.get $parts)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (local.get $count) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
              (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $part_ptr) (local.get $part_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $part_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $s2_ptr (i32.const 368))
      (local.set $s2_len (i32.const 15))
    (local.set $words (call $__str_split (local.get $s2_ptr) (local.get $s2_len) (i32.const 383) (i32.const 1)))
    (local.set $__forof_idx (i32.const 0))
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.ge_u (local.get $__forof_idx) (i32.load (local.get $words))))
        (local.set $w_ptr (i32.load (i32.add (i32.add (local.get $words) (i32.const 8)) (i32.shl (local.get $__forof_idx) (i32.const 3)))))
        (local.set $w_len (i32.load offset=4 (i32.add (i32.add (local.get $words) (i32.const 8)) (i32.shl (local.get $__forof_idx) (i32.const 3)))))
        (block $cont_1
              (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (local.get $w_ptr) (local.get $w_len) (i32.const 132))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (local.get $w_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    ...
    (call $testCharCodeAt )
    (call $testCharAt )
    (call $testStartsEndsWith )
    (call $testCaseConversion )
    (call $testReplace )
    (call $testPad )
    (call $testRepeat )
    (call $testSplit )
  ...
  (data (i32.const 260) "\20\20\68\65\6c\6c\6f\20\77\6f\72\6c\64\20\20")
  (data (i32.const 275) "\20\20\6c\65\61\64\69\6e\67")
  (data (i32.const 284) "\74\72\61\69\6c\69\6e\67\20\20")
  (data (i32.const 294) "\41\42\43")
  (data (i32.const 297) "\68\65\6c\6c\6f")
  (data (i32.const 302) "\68\65\6c\6c\6f\20\77\6f\72\6c\64")
  (data (i32.const 313) "\74\72\75\65")
  (data (i32.const 317) "\66\61\6c\73\65")
  (data (i32.const 322) "\77\6f\72\6c\64")
  (data (i32.const 327) "\48\65\6c\6c\6f\20\57\6f\72\6c\64")
  (data (i32.const 338) "\66\6f\6f\20\62\61\72\20\66\6f\6f")
  (data (i32.const 349) "\66\6f\6f")
  (data (i32.const 352) "\62\61\7a")
  (data (i32.const 355) "\34\32")
  (data (i32.const 357) "\30")
  (data (i32.const 358) "\2e")
  (data (i32.const 359) "\61\62")
  (data (i32.const 361) "\78")
  (data (i32.const 362) "\61\2c\62\2c\63")
  (data (i32.const 367) "\2c")
  (data (i32.const 368) "\68\65\6c\6c\6f\20\77\6f\72\6c\64\20\66\6f\6f")
  (data (i32.const 383) "\20")
)