(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 306))
  ...
  (func $__ta_set_i32 (param $dst i32) (param $src i32) (param $offset i32)
    (local $i i32)
    (local $len i32)
    (local $dst_data i32)
    (local $src_data i32)
    ...
    (block $done
      (loop $loop
        ...
        (i32.store
          (i32.add (local.get $dst_data) (i32.shl (i32.add (local.get $i) (local.get $offset)) (i32.const 2)))
          (i32.load (i32.add (local.get $src_data) (i32.shl (local.get $i) (i32.const 2)))))
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $loop)
      )
    )
  )
  (func $testTypedArrayFillAndSet (export "testTypedArrayFillAndSet")  
    (local $buf i32)
    (local $src i32)
    ...
    (local $__arr_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $buf (call $__malloc (i32.const 28)))
      (i32.store (local.get $buf) (i32.const 5))
    (call $__ta_fill_i32 (local.get $buf) (i32.const 42) (i32.const 1) (i32.const 4))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 141) (i32.const 120))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $buf) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 146))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $buf) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 146))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 141) (i32.const 120))
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 52))
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $buf) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 2)))) (i32.const 146))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $src (call $__malloc (i32.const 16)))
      (i32.store (local.get $src) (i32.const 2))
      (i32.store (i32.add (local.get $src) (i32.const 8)) (i32.const 100))
      (i32.store (i32.add (local.get $src) (i32.const 12)) (i32.const 200))
    (call $__ta_set_i32 (local.get $buf) (local.get $src) (i32.const 3))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 140) (i32.const 120))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $buf) (i32.const 8)) (i32.shl (i32.const 3) (i32.const 2)))) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 120))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store8 (i32.const 142) (i32.const 52))
          (i32.store8 (i32.const 143) (i32.const 58))
          (i32.store8 (i32.const 144) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $buf) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 2)))) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testTypedArrayFillAndSet )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\54\79\70\65\64\41\72\72\61\79\20\2e\66\69\6c\6c\28\29\20\61\6e\64\20\2e\73\65\74\28\29\20\2d\2d\2d\0a")
)