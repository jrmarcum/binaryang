(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 309))
  ...
  (func $testNestedForOf (export "testNestedForOf")  
    (local $matrix i32)
    (local $__2d_tmp i32)
    (local $total i32)
    (local $row i32)
    ...
    (local $val i32)
    (local $__forof_idx1 i32)
    (local $__iface_tmp i32)
    (local $__arr_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          (i32.store (i32.const 4) (i32.const 49))
          (drop (call $fd_write
            (i32.const 1)
            (i32.const 0)
            (i32.const 1)
    ...
    (local.set $matrix (call $__malloc (i32.const 40)))
      (i32.store (local.get $matrix) (i32.const 3))
      (i32.store offset=4 (local.get $matrix) (i32.const 8))
      (i32.store offset=8 (local.get $matrix) (local.tee $__2d_tmp (call $__malloc (i32.const 40))))
      (i32.store (local.get $__2d_tmp) (i32.const 2))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (i32.store offset=8 (local.get $__2d_tmp) (i32.const 1))
      (i32.store offset=12 (local.get $__2d_tmp) (i32.const 2))
      (i32.store offset=12 (local.get $matrix) (local.tee $__2d_tmp (call $__malloc (i32.const 40))))
      (i32.store (local.get $__2d_tmp) (i32.const 2))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (i32.store offset=8 (local.get $__2d_tmp) (i32.const 3))
      (i32.store offset=12 (local.get $__2d_tmp) (i32.const 4))
      (i32.store offset=16 (local.get $matrix) (local.tee $__2d_tmp (call $__malloc (i32.const 40))))
      (i32.store (local.get $__2d_tmp) (i32.const 2))
      (i32.store offset=4 (local.get $__2d_tmp) (i32.const 8))
      (i32.store offset=8 (local.get $__2d_tmp) (i32.const 5))
      (i32.store offset=12 (local.get $__2d_tmp) (i32.const 6))
    (local.set $total (i32.const 0))
    (local.set $__forof_idx (i32.const 0))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.ge_u (local.get $__forof_idx) (i32.load (local.get $matrix))))
        (local.set $row (i32.load (i32.add (i32.add (local.get $matrix) (i32.const 8)) (i32.shl (local.get $__forof_idx) (i32.const 2)))))
        (block $cont_0
          (local.set $__forof_idx1 (i32.const 0))
          (block $break_1
            (loop $loop_1
              (br_if $break_1 (i32.ge_u (local.get $__forof_idx1) (i32.load (local.get $row))))
              (local.set $val (i32.load (i32.add (i32.add (local.get $row) (i32.const 8)) (i32.shl (local.get $__forof_idx1) (i32.const 2)))))
              (block $cont_1
                (local.set $total (i32.add (local.get $total) (local.get $val)))
              )
              (local.set $__forof_idx1 (i32.add (local.get $__forof_idx1) (i32.const 1)))
              (br $loop_1)
            )
          )
        )
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 132) (i32.const 77))
          ...
          (i32.store8 (i32.const 137) (i32.const 120))
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store8 (i32.const 139) (i32.const 84))
          ...
          (i32.store8 (i32.const 145) (i32.const 83))
          (i32.store8 (i32.const 146) (i32.const 117))
          (i32.store8 (i32.const 147) (i32.const 109))
          (i32.store8 (i32.const 148) (i32.const 58))
          (i32.store8 (i32.const 149) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 18) (call $__i32_to_str (local.get $total) (i32.const 150))))
  ...
  (func $_start (export "_start")
    (call $testNestedForOf )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\33\3a\20\4e\65\73\74\65\64\20\66\6f\72\2e\2e\2e\6f\66\20\4d\61\74\72\69\78\20\49\74\65\72\61\74\69\6f\6e\20\2d\2d\2d\0a")
)