(module
  ...
  (func $testTypedArrayAccess (export "testTypedArrayAccess")  
    (local $bytes i32)
    (local $shorts i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $bytes (call $__malloc (i32.const 12)))
      (i32.store (local.get $bytes) (i32.const 4))
    (i32.store8 (i32.add (i32.add (local.get $bytes) (i32.const 8)) (i32.const 0)) (i32.const 255))
    (i32.store8 (i32.add (i32.add (local.get $bytes) (i32.const 8)) (i32.const 1)) (i32.const 128))
    (i32.store8 (i32.add (i32.add (local.get $bytes) (i32.const 8)) (i32.const 2)) (i32.const 64))
    (i32.store8 (i32.add (i32.add (local.get $bytes) (i32.const 8)) (i32.const 3)) (i32.const 32))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 85))
          (i32.store8 (i32.const 133) (i32.const 105))
          (i32.store8 (i32.const 134) (i32.const 110))
          (i32.store8 (i32.const 135) (i32.const 116))
          (i32.store8 (i32.const 136) (i32.const 56))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store8 (i32.const 138) (i32.const 76))
          (i32.store8 (i32.const 139) (i32.const 101))
          (i32.store8 (i32.const 140) (i32.const 110))
          (i32.store8 (i32.const 141) (i32.const 103))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (i32.load (local.get $bytes)) (i32.const 146))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 48))
          (i32.store8 (i32.const 145) (i32.const 58))
          (i32.store8 (i32.const 146) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (i32.load8_u (i32.add (i32.add (local.get $bytes) (i32.const 8)) (i32.const 0))) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 145) (i32.const 58))
          (i32.store8 (i32.const 146) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (i32.load8_u (i32.add (i32.add (local.get $bytes) (i32.const 8)) (i32.const 2))) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $shorts (call $__malloc (i32.const 12)))
      (i32.store (local.get $shorts) (i32.const 2))
    (i32.store16 (i32.add (i32.add (local.get $shorts) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 1))) (i32.const 32000))
    (i32.store16 (i32.add (i32.add (local.get $shorts) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 1))) (i32.const -16000))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 73))
          (i32.store8 (i32.const 133) (i32.const 110))
          (i32.store8 (i32.const 134) (i32.const 116))
          (i32.store8 (i32.const 135) (i32.const 49))
          (i32.store8 (i32.const 136) (i32.const 54))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store8 (i32.const 138) (i32.const 66))
          (i32.store8 (i32.const 139) (i32.const 121))
          (i32.store8 (i32.const 140) (i32.const 116))
          ...
          (i32.store8 (i32.const 148) (i32.const 58))
          (i32.store8 (i32.const 149) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 18) (call $__i32_to_str (i32.shl (i32.load (local.get $shorts)) (i32.const 1)) (i32.const 150))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 145) (i32.const 58))
          (i32.store8 (i32.const 146) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (i32.load16_s (i32.add (i32.add (local.get $shorts) (i32.const 8)) (i32.shl (i32.const 1) (i32.const 1)))) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testTypedArrayAccess )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\54\79\70\65\64\41\72\72\61\79\20\53\75\62\2d\57\6f\72\64\20\41\63\63\65\73\73\20\2d\2d\2d\0a")
)