(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 333))
  ...
  (func $processAction (param $action i32) (result i32)
    (block $switch_exit_0
      (block $case_0_2
        (block $case_0_1
          (block $case_0_0
            (br_if $case_0_0 (i32.eq (i32.load (local.get $action)) (i32.const 0)))
            (br_if $case_0_1 (i32.eq (i32.load (local.get $action)) (i32.const 1)))
            (br_if $case_0_2 (i32.eq (i32.load (local.get $action)) (i32.const 2)))
            (br $switch_exit_0)
          )
            (return (i32.mul (i32.load (i32.add (local.get $action) (i32.const 4))) (i32.const 10)))
        )
          (return (i32.load (i32.add (local.get $action) (i32.const 8))))
      )
        (return (i32.const 0))
    )
      (unreachable)
  ...
  (func $testSwitchDispatch (export "testSwitchDispatch")  
    (local $a1 i32)
    (local $a2 i32)
    (local $a3 i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 296))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $a1 (i32.const 260))
    (local.set $a2 (i32.const 272))
    (local.set $a3 (i32.const 284))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 82))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (call $processAction (local.get $a1)) (i32.const 146))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 82))
          (i32.store8 (i32.const 138) (i32.const 101))
          (i32.store8 (i32.const 139) (i32.const 115))
          (i32.store8 (i32.const 140) (i32.const 117))
          (i32.store8 (i32.const 141) (i32.const 108))
          (i32.store8 (i32.const 142) (i32.const 116))
          (i32.store8 (i32.const 143) (i32.const 58))
          (i32.store8 (i32.const 144) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__i32_to_str (call $processAction (local.get $a2)) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (call $processAction (local.get $a3)) (i32.const 146))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    ...
    (;; | { type: "stop"; code: i32 };)
    (;; | { type: "pause" };;)
    (call $testSwitchDispatch )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 296) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\53\77\69\74\63\68\20\43\61\73\65\20\44\69\73\70\61\74\63\68\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00\03\00\00\00\00\00\00\00")
  (data (i32.const 272) "\01\00\00\00\00\00\00\00\94\01\00\00")
  (data (i32.const 284) "\02\00\00\00\00\00\00\00\00\00\00\00")
)