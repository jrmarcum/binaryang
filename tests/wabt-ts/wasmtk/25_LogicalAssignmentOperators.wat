(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 305))
  (global $__d4s (mut i32) (i32.const 0))
  (global $__free_list (mut i32) (i32.const 0))
  (global $__nullable_ret_flag (mut i32) (i32.const 0))
  (global $globalNullable (mut i32) (i32.const 0))
  (global $globalCounter (mut i32) (i32.const 10))
  (global $globalNullable__null (mut i32) (i32.const 1))
  ...
  (func $testLogicalAssignments (export "testLogicalAssignments")  
    (local $localNullable i32)
    (local $localNullable__null i32)
    (local $zeroLocal i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $localNullable__null (i32.const 1))
    (if (local.get $localNullable__null) (then (local.set $localNullable (i32.const 55)) (local.set $localNullable__null (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 76))
          ...
          (i32.store8 (i32.const 138) (i32.const 63))
          (i32.store8 (i32.const 139) (i32.const 63))
          ...
          (i32.store8 (i32.const 148) (i32.const 108))
          (i32.store8 (i32.const 149) (i32.const 58))
          (i32.store8 (i32.const 150) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (local.get $localNullable) (i32.const 151))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (if (local.get $localNullable__null) (then (local.set $localNullable (i32.const 100)) (local.set $localNullable__null (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 76))
          (i32.store8 (i32.const 133) (i32.const 111))
          ...
          (i32.store8 (i32.const 148) (i32.const 45))
          (i32.store8 (i32.const 149) (i32.const 110))
          (i32.store8 (i32.const 150) (i32.const 117))
          (i32.store8 (i32.const 151) (i32.const 108))
          (i32.store8 (i32.const 152) (i32.const 108))
          (i32.store8 (i32.const 153) (i32.const 58))
          (i32.store8 (i32.const 154) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 23) (call $__i32_to_str (local.get $localNullable) (i32.const 155))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (if (global.get $globalNullable__null) (then (global.set $globalNullable (i32.const 77)) (global.set $globalNullable__null (i32.const 0))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 139) (i32.const 63))
          (i32.store8 (i32.const 140) (i32.const 63))
          (i32.store8 (i32.const 141) (i32.const 61))
          ...
          (i32.store8 (i32.const 147) (i32.const 117))
          (i32.store8 (i32.const 148) (i32.const 108))
          (i32.store8 (i32.const 149) (i32.const 108))
          (i32.store8 (i32.const 150) (i32.const 58))
          (i32.store8 (i32.const 151) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__i32_to_str (global.get $globalNullable) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $zeroLocal (i32.const 0))
    (if (i32.eqz (local.get $zeroLocal)) (then (local.set $zeroLocal (i32.const 300))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 76))
          (i32.store8 (i32.const 133) (i32.const 111))
          ...
          (i32.store8 (i32.const 136) (i32.const 108))
          (i32.store8 (i32.const 137) (i32.const 32))
          (i32.store8 (i32.const 138) (i32.const 124))
          (i32.store8 (i32.const 139) (i32.const 124))
          (i32.store8 (i32.const 140) (i32.const 61))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store8 (i32.const 142) (i32.const 111))
          (i32.store8 (i32.const 143) (i32.const 110))
          ...
          (i32.store8 (i32.const 149) (i32.const 58))
          (i32.store8 (i32.const 150) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (local.get $zeroLocal) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (if (global.get $globalCounter) (then (global.set $globalCounter (i32.const 20))))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 71))
          (i32.store8 (i32.const 133) (i32.const 108))
          ...
          (i32.store8 (i32.const 137) (i32.const 108))
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store8 (i32.const 139) (i32.const 38))
          (i32.store8 (i32.const 140) (i32.const 38))
          (i32.store8 (i32.const 141) (i32.const 61))
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 111))
          (i32.store8 (i32.const 144) (i32.const 110))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store8 (i32.const 146) (i32.const 116))
          (i32.store8 (i32.const 147) (i32.const 114))
          (i32.store8 (i32.const 148) (i32.const 117))
          (i32.store8 (i32.const 149) (i32.const 116))
          (i32.store8 (i32.const 150) (i32.const 104))
          (i32.store8 (i32.const 151) (i32.const 121))
          (i32.store8 (i32.const 152) (i32.const 58))
          (i32.store8 (i32.const 153) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 22) (call $__i32_to_str (global.get $globalCounter) (i32.const 154))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testLogicalAssignments )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\4c\6f\67\69\63\61\6c\20\41\73\73\69\67\6e\6d\65\6e\74\20\4f\70\65\72\61\74\6f\72\73\20\2d\2d\2d\0a")
)