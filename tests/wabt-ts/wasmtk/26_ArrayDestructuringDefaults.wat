(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 311))
  ...
  (func $testDestructuringDefaults (export "testDestructuringDefaults")  
    (local $partialArr i32)
    (local $a i32)
    (local $b i32)
    (local $c i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 272))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $partialArr (i32.const 260))
    (local.set $a (i32.load (i32.const 268)))
      ...
      (local.set $c (i32.const 3))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 80))
          ...
          (i32.store8 (i32.const 150) (i32.const 41))
          (i32.store8 (i32.const 151) (i32.const 58))
          (i32.store8 (i32.const 152) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 21) (call $__i32_to_str (local.get $a) (i32.const 153))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 145) (i32.const 102))
          ...
          (i32.store8 (i32.const 151) (i32.const 58))
          (i32.store8 (i32.const 152) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 21) (call $__i32_to_str (local.get $b) (i32.const 153))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 151) (i32.const 58))
          (i32.store8 (i32.const 152) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 21) (call $__i32_to_str (local.get $c) (i32.const 153))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testDestructuringDefaults )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 272) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\44\65\73\74\72\75\63\74\75\72\69\6e\67\20\44\65\66\61\75\6c\74\73\20\2d\2d\2d\0a")
  (data (i32.const 260) "\01\00\00\00\01\00\00\00\64\00\00\00")
)