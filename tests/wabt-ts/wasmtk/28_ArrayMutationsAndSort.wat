(module
  ...
  (func $descCompare (param $a i32) (param $b i32) (result i32)
    (return (i32.sub (local.get $b) (local.get $a)))
  )

  (func $testMutationsAndSort (export "testMutationsAndSort")  
    (local $arr i32)
    (local $fillArr i32)
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $arr (call $__malloc (i32.const 48)))
      (i32.store (local.get $arr) (i32.const 5))
      (i32.store offset=4 (local.get $arr) (i32.const 10))
      (i32.store offset=8 (local.get $arr) (i32.const 5))
      (i32.store offset=12 (local.get $arr) (i32.const 2))
      (i32.store offset=16 (local.get $arr) (i32.const 8))
      (i32.store offset=20 (local.get $arr) (i32.const 1))
      (i32.store offset=24 (local.get $arr) (i32.const 9))
    (drop (call $__dynarr_reverse_i32 (local.get $arr)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 82))
          (i32.store8 (i32.const 133) (i32.const 101))
          (i32.store8 (i32.const 134) (i32.const 118))
          ...
          (i32.store8 (i32.const 141) (i32.const 73))
          (i32.store8 (i32.const 142) (i32.const 110))
          (i32.store8 (i32.const 143) (i32.const 100))
          (i32.store8 (i32.const 144) (i32.const 101))
          (i32.store8 (i32.const 145) (i32.const 120))
          (i32.store8 (i32.const 146) (i32.const 32))
          (i32.store8 (i32.const 147) (i32.const 48))
          (i32.store8 (i32.const 148) (i32.const 58))
          (i32.store8 (i32.const 149) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 18) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 150))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (drop (call $__dynarr_sort_i32 (local.get $arr)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 143) (i32.const 73))
          (i32.store8 (i32.const 144) (i32.const 110))
          ...
          (i32.store8 (i32.const 149) (i32.const 48))
          (i32.store8 (i32.const 150) (i32.const 58))
          (i32.store8 (i32.const 151) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 147) (i32.const 120))
          (i32.store8 (i32.const 148) (i32.const 32))
          (i32.store8 (i32.const 149) (i32.const 52))
          (i32.store8 (i32.const 150) (i32.const 58))
          (i32.store8 (i32.const 151) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 2)))) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (drop (call $__dynarr_sortcmp_i32 (local.get $arr) (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 83))
          (i32.store8 (i32.const 133) (i32.const 111))
          ...
          (i32.store8 (i32.const 144) (i32.const 73))
          (i32.store8 (i32.const 145) (i32.const 110))
          (i32.store8 (i32.const 146) (i32.const 100))
          (i32.store8 (i32.const 147) (i32.const 101))
          (i32.store8 (i32.const 148) (i32.const 120))
          (i32.store8 (i32.const 149) (i32.const 32))
          (i32.store8 (i32.const 150) (i32.const 48))
          (i32.store8 (i32.const 151) (i32.const 58))
          (i32.store8 (i32.const 152) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 21) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $arr) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 153))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $fillArr (call $__malloc (i32.const 48)))
      (i32.store (local.get $fillArr) (i32.const 5))
      (i32.store offset=4 (local.get $fillArr) (i32.const 10))
      (i32.store offset=8 (local.get $fillArr) (i32.const 0))
      (i32.store offset=12 (local.get $fillArr) (i32.const 0))
      (i32.store offset=16 (local.get $fillArr) (i32.const 0))
      (i32.store offset=20 (local.get $fillArr) (i32.const 0))
      (i32.store offset=24 (local.get $fillArr) (i32.const 0))
    (drop (call $__dynarr_fill_i32 (local.get $fillArr) (i32.const 7) (i32.const 1) (i32.const 4)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 137) (i32.const 100))
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store8 (i32.const 139) (i32.const 73))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 16) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fillArr) (i32.const 8)) (i32.shl (i32.const 0) (i32.const 2)))) (i32.const 148))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 146) (i32.const 58))
          (i32.store8 (i32.const 147) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 16) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fillArr) (i32.const 8)) (i32.shl (i32.const 2) (i32.const 2)))) (i32.const 148))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 120))
          (i32.store8 (i32.const 144) (i32.const 32))
          (i32.store8 (i32.const 145) (i32.const 52))
          (i32.store8 (i32.const 146) (i32.const 58))
          (i32.store8 (i32.const 147) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 16) (call $__i32_to_str (i32.load (i32.add (i32.add (local.get $fillArr) (i32.const 8)) (i32.shl (i32.const 4) (i32.const 2)))) (i32.const 148))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testMutationsAndSort )
    (call $proc_exit (i32.const 0))
  )
  (table 1 funcref)
  (elem (i32.const 0) $descCompare)
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\52\65\76\65\72\73\65\2c\20\46\69\6c\6c\20\26\20\53\6f\72\74\20\2d\2d\2d\0a")
)