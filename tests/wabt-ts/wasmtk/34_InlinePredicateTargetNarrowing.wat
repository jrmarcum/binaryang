(module
  ...
  (func $testInlinePredicateTarget (export "testInlinePredicateTarget")  
    (local $c i32)
    (local $s i32)
    (local $c2 i32)
    (local $s2 i32)
    ...
    (local.set $s (local.get $c))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 11) (call $__f64_to_str (if (result f64) (call $isCircle (local.get $s)) (then (f64.const 1)) (else (f64.const 0))) (i32.const 143))))
    ...
    (if (call $isCircle (local.get $s))
      (then
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__f64_to_str (f64.load (i32.add (local.get $s) (i32.const 8))) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (local.set $c2 (i32.const 276))
    (local.set $s2 (local.get $c2))
    (if (call $isCircleNamed (local.get $s2))
      (then
          (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 78))
          ...
          (i32.store8 (i32.const 145) (i32.const 82))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 21) (call $__f64_to_str (f64.load (i32.add (local.get $s2) (i32.const 8))) (i32.const 153))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $isCircleNamed (param $s i32) (result i32)
    (return (i32.eq (i32.load (i32.add (local.get $s) (i32.const 0))) (i32.const 0)))
  )
  (func $_start (export "_start")
    (call $testInlinePredicateTarget )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\14\40")
  (data (i32.const 276) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\23\40")
)