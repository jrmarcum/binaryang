(module
  ...
  (global $Cfg_LIMIT i32 (i32.const 7))
  (global $Cfg_RATE f64 (f64.const 1.5))
  ...
  (func $Cfg_greet (param $who_ptr i32) (param $who_len i32) 
    (local $__ret_str_ptr i32)
    (local $__ret_str_len i32)
    (local.set $__ret_str_ptr (i32.const 263))
      (local.set $__ret_str_len (i32.const 3))
      (call $__str_concat (local.get $__ret_str_ptr) (local.get $__ret_str_len) (local.get $who_ptr) (local.get $who_len))
  ...
  (func $Cfg_twice (param $v i32) (result i32)
    (return (i32.mul (local.get $v) (global.get $Cfg_LIMIT)))
  )

  (func $testNamespaceStringMembers (export "testNamespaceStringMembers")  
    (local $s_ptr i32)
    (local $s_len i32)
    (local $b i32)
    ...
    (local $__str_op_len i32)
        (i32.store (i32.const 0) (i32.const 283))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 115))
          (i32.store8 (i32.const 143) (i32.const 116))
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (call $__str_gather (i32.const 260) (i32.const 3) (i32.const 146))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (i32.const 3)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 50))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 11) (call $__i32_to_str (global.get $Cfg_LIMIT) (i32.const 143))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 133) (i32.const 54))
          (i32.store8 (i32.const 134) (i32.const 52))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store8 (i32.const 136) (i32.const 99))
          (i32.store8 (i32.const 137) (i32.const 111))
          (i32.store8 (i32.const 138) (i32.const 110))
          ...
          (i32.store8 (i32.const 141) (i32.const 58))
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 11) (call $__f64_to_str (global.get $Cfg_RATE) (i32.const 143))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 145) (i32.const 105))
          ...
          (call $Cfg_greet (i32.const 316) (i32.const 5))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 150))
          (i32.store (i32.const 4) (i32.add (i32.const 18) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (call $Cfg_greet (i32.const 321) (i32.const 1))
(local.set $s_ptr (global.get $__str_ret_ptr))
      (local.set $s_len (global.get $__str_ret_len))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 145) (i32.const 105))
          (i32.store8 (i32.const 146) (i32.const 103))
          (i32.store8 (i32.const 147) (i32.const 110))
          (i32.store8 (i32.const 148) (i32.const 101))
          (i32.store8 (i32.const 149) (i32.const 100))
          (i32.store8 (i32.const 150) (i32.const 58))
          (i32.store8 (i32.const 151) (i32.const 32))
          (call $__str_gather (local.get $s_ptr) (local.get $s_len) (i32.const 152))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (local.get $s_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 145) (i32.const 99))
          (i32.store8 (i32.const 146) (i32.const 111))
          (i32.store8 (i32.const 147) (i32.const 110))
          (i32.store8 (i32.const 148) (i32.const 99))
          (i32.store8 (i32.const 149) (i32.const 97))
          (i32.store8 (i32.const 150) (i32.const 116))
          (i32.store8 (i32.const 151) (i32.const 58))
          (i32.store8 (i32.const 152) (i32.const 32))
          (i32.store8 (i32.const 153) (i32.const 91))
          (call $__str_gather (i32.const 260) (i32.const 3) (i32.const 154))
          (i32.store (i32.const 4) (i32.add (i32.const 22) (i32.const 3)))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 93))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 148) (i32.const 112))
          (i32.store8 (i32.const 149) (i32.const 97))
          (i32.store8 (i32.const 150) (i32.const 114))
          (i32.store8 (i32.const 151) (i32.const 101))
          (i32.store8 (i32.const 152) (i32.const 58))
          (i32.store8 (i32.const 153) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 22) (call $__f64_to_str (if (result f64) (i32.eqz (call $__str_cmp (block (result i32) (i32.const 260) (i32.const 3) (local.set $__str_op_len)) (local.get $__str_op_len) (i32.const 260) (i32.const 3))) (then (f64.const 1)) (else (f64.const 0))) (i32.const 154))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 134) (i32.const 50))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store8 (i32.const 136) (i32.const 102))
          (i32.store8 (i32.const 137) (i32.const 110))
          (i32.store8 (i32.const 138) (i32.const 58))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (call $Cfg_twice (i32.const 3)) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $b (i32.const 266))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 115))
          (i32.store8 (i32.const 133) (i32.const 116))
          (i32.store8 (i32.const 134) (i32.const 114))
          (i32.store8 (i32.const 135) (i32.const 117))
          (i32.store8 (i32.const 136) (i32.const 99))
          ...
          (i32.store8 (i32.const 144) (i32.const 32))
          (i32.store8 (i32.const 145) (i32.const 78))
          (i32.store8 (i32.const 146) (i32.const 65))
          (i32.store8 (i32.const 147) (i32.const 77))
          (i32.store8 (i32.const 148) (i32.const 69))
          (i32.store8 (i32.const 149) (i32.const 58))
          (i32.store8 (i32.const 150) (i32.const 32))
          (call $__str_gather (i32.load offset=0 (i32.const 266)) (i32.load offset=4 (i32.const 266)) (i32.const 151))
          (i32.store (i32.const 4) (i32.add (i32.const 19) (i32.load offset=4 (i32.const 266))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 100))
          (i32.store8 (i32.const 144) (i32.const 32))
          (i32.store8 (i32.const 145) (i32.const 76))
          (i32.store8 (i32.const 146) (i32.const 73))
          (i32.store8 (i32.const 147) (i32.const 77))
          (i32.store8 (i32.const 148) (i32.const 73))
          (i32.store8 (i32.const 149) (i32.const 84))
          (i32.store8 (i32.const 150) (i32.const 58))
          (i32.store8 (i32.const 151) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__i32_to_str (i32.load (i32.add (i32.const 266) (i32.const 8))) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 322))
          (i32.store (i32.const 4) (i32.const 35))
          (drop (call $fd_write
            (i32.const 1)
            (i32.const 0)
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (local $Cfg_NAME_ptr i32)
    (local $Cfg_NAME_len i32)
    (local.set $Cfg_NAME_ptr (i32.const 260))
      (local.set $Cfg_NAME_len (i32.const 3))
    (call $testNamespaceStringMembers )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\63\66\67")
  (data (i32.const 263) "\68\69\20")
  (data (i32.const 278) "\66\69\65\6c\64")
  (data (i32.const 283) "\2d\2d\2d\20\4e\61\6d\65\73\70\61\63\65\20\73\74\72\69\6e\67\20\6d\65\6d\62\65\72\73\20\2d\2d\2d\0a")
  (data (i32.const 316) "\74\68\65\72\65")
  (data (i32.const 321) "\78")
  (data (i32.const 322) "\6c\69\74\65\72\61\6c\3a\20\43\66\67\2e\4e\41\4d\45\20\73\74\61\79\73\20\61\73\20\77\72\69\74\74\65\6e\0a")
  (data (i32.const 266) "\16\01\00\00\05\00\00\00\63\00\00\00")
)