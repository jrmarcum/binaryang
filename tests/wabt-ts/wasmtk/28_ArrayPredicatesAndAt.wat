(module
  ...
  (func $isEven (param $x i32) (result i32)
    (return (i32.eq (i32.rem_s (local.get $x) (i32.const 2)) (i32.const 0)))
  )

  (func $testPredicatesAndAt (export "testPredicatesAndAt")  
    (local $numbers i32)
    (local $allPositive i32)
    (local $hasEven i32)
    (local $firstMatchIdx i32)
    (local $lastElem i32)
    (local $secondLast i32)
    ...
    (local $__str_op_len i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $numbers (call $__malloc (i32.const 48)))
      (i32.store (local.get $numbers) (i32.const 5))
      (i32.store offset=4 (local.get $numbers) (i32.const 10))
      (i32.store offset=8 (local.get $numbers) (i32.const 2))
      (i32.store offset=12 (local.get $numbers) (i32.const 4))
      (i32.store offset=16 (local.get $numbers) (i32.const 6))
      (i32.store offset=20 (local.get $numbers) (i32.const 8))
      (i32.store offset=24 (local.get $numbers) (i32.const 10))
    (local.set $allPositive (call $__dynarr_every_i32 (local.get $numbers) (i32.const 1)))
    (local.set $hasEven (call $__dynarr_some_i32 (local.get $numbers) (i32.const 2)))
    (local.set $firstMatchIdx (call $__dynarr_findindex_i32 (local.get $numbers) (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 80))
          ...
          (i32.store8 (i32.const 142) (i32.const 118))
          (i32.store8 (i32.const 143) (i32.const 101))
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (call $__i32_to_str (if (result i32) (local.get $allPositive) (then (i32.const 1)) (else (i32.const 0))) (i32.const 146))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 72))
          (i32.store8 (i32.const 133) (i32.const 97))
          (i32.store8 (i32.const 134) (i32.const 115))
          (i32.store8 (i32.const 135) (i32.const 32))
          (i32.store8 (i32.const 136) (i32.const 69))
          (i32.store8 (i32.const 137) (i32.const 118))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (if (result i32) (local.get $hasEven) (then (i32.const 1)) (else (i32.const 0))) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 120))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store8 (i32.const 144) (i32.const 62))
          (i32.store8 (i32.const 145) (i32.const 32))
          (i32.store8 (i32.const 146) (i32.const 53))
          (i32.store8 (i32.const 147) (i32.const 58))
          (i32.store8 (i32.const 148) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__i32_to_str (local.get $firstMatchIdx) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $lastElem (call $__dynarr_at_i32 (local.get $numbers) (i32.const -1)))
    (local.set $secondLast (call $__dynarr_at_i32 (local.get $numbers) (i32.const -2)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 137) (i32.const 69))
          ...
          (i32.store8 (i32.const 145) (i32.const 40))
          (i32.store8 (i32.const 146) (i32.const 45))
          (i32.store8 (i32.const 147) (i32.const 49))
          (i32.store8 (i32.const 148) (i32.const 41))
          (i32.store8 (i32.const 149) (i32.const 58))
          (i32.store8 (i32.const 150) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 19) (call $__i32_to_str (local.get $lastElem) (i32.const 151))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 76))
          (i32.store8 (i32.const 140) (i32.const 97))
          (i32.store8 (i32.const 141) (i32.const 115))
          (i32.store8 (i32.const 142) (i32.const 116))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store8 (i32.const 144) (i32.const 40))
          (i32.store8 (i32.const 145) (i32.const 45))
          (i32.store8 (i32.const 146) (i32.const 50))
          (i32.store8 (i32.const 147) (i32.const 41))
          (i32.store8 (i32.const 148) (i32.const 58))
          (i32.store8 (i32.const 149) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 18) (call $__i32_to_str (local.get $secondLast) (i32.const 150))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $__anon_0 (param $x i32) (result i32)
    (return (i32.gt_s (local.get $x) (i32.const 5)))
  )
  (func $_start (export "_start")
    (call $testPredicatesAndAt )
    (call $proc_exit (i32.const 0))
  )
  (table 3 funcref)
  (elem (i32.const 0) $__anon_0 $isPositive $isEven)
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\41\72\72\61\79\20\50\72\65\64\69\63\61\74\65\73\20\26\20\61\74\28\29\20\2d\2d\2d\0a")
)