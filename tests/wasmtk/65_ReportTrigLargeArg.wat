(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 287))
  ...
  (func $check (param $cond i32) 
    ...
    (if (i32.eq (local.get $cond) (i32.const 0))
      (then
      (local.set $x (i32.load (i32.add (i32.add (global.get $guard) (i32.const 8)) (i32.shl (i32.const 9000000) (i32.const 2)))))
  ...
  (func $_start (export "_start")
    ...
    (local.set $s (call $mathlib_sin (f64.const 500000000)))
    (call $check (if (result i32) (if (result i32) (f64.gt (local.get $s) (f64.const -0.284704074)) (then (f64.lt (local.get $s) (f64.const -0.284704073))) (else (i32.const 0))) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $c (call $mathlib_cos (f64.const 500000000)))
    (call $check (if (result i32) (if (result i32) (f64.gt (local.get $c) (f64.const -0.958615456)) (then (f64.lt (local.get $c) (f64.const -0.958615455))) (else (i32.const 0))) (then (i32.const 1)) (else (i32.const 0))))
    (local.set $t (call $mathlib_tan (f64.const 500000000)))
    (call $check (if (result i32) (if (result i32) (f64.gt (local.get $t) (f64.const 0.296995079)) (then (f64.lt (local.get $t) (f64.const 0.296995080))) (else (i32.const 0))) (then (i32.const 1)) (else (i32.const 0))))
  ...
  (data (i32.const 260) "\74\72\69\67\20\6c\61\72\67\65\2d\61\72\67\20\61\63\63\75\72\61\63\79\20\6f\6b\0a")
