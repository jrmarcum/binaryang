(module
  ...
  (func $testUnionSharedFieldWidening (export "testUnionSharedFieldWidening")  
    (local $s1 i32)
    (local $s2 i32)
    (local $m1 i32)
    (local $m2 i32)
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 348))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $s1 (i32.const 260))
    (local.set $s2 (i32.const 268))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 104))
          ...
          (i32.store8 (i32.const 149) (i32.const 115))
          (i32.store8 (i32.const 150) (i32.const 108))
          (i32.store8 (i32.const 151) (i32.const 111))
          (i32.store8 (i32.const 152) (i32.const 116))
          (i32.store8 (i32.const 153) (i32.const 58))
          (i32.store8 (i32.const 154) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 23) (call $__i32_to_str (i32.add (i32.load (i32.add (i32.const 260) (i32.const 4))) (i32.load (i32.add (i32.const 268) (i32.const 4)))) (i32.const 155))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $m1 (i32.const 276))
    (local.set $m2 (i32.const 296))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 144) (i32.const 112))
          (i32.store8 (i32.const 145) (i32.const 97))
          (i32.store8 (i32.const 146) (i32.const 121))
          (i32.store8 (i32.const 147) (i32.const 108))
          (i32.store8 (i32.const 148) (i32.const 111))
          (i32.store8 (i32.const 149) (i32.const 97))
          (i32.store8 (i32.const 150) (i32.const 100))
          (i32.store8 (i32.const 151) (i32.const 58))
          (i32.store8 (i32.const 152) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 21) (call $__f64_to_str (f64.load (i32.add (i32.const 276) (i32.const 8))) (i32.const 153))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 100))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store8 (i32.const 140) (i32.const 102))
          ...
          (i32.store8 (i32.const 146) (i32.const 112))
          (i32.store8 (i32.const 147) (i32.const 97))
          (i32.store8 (i32.const 148) (i32.const 121))
          (i32.store8 (i32.const 149) (i32.const 108))
          (i32.store8 (i32.const 150) (i32.const 111))
          (i32.store8 (i32.const 151) (i32.const 97))
          (i32.store8 (i32.const 152) (i32.const 100))
          (i32.store8 (i32.const 153) (i32.const 58))
          (i32.store8 (i32.const 154) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 23) (call $__f64_to_str (f64.load (i32.add (i32.const 296) (i32.const 8))) (i32.const 155))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store8 (i32.const 144) (i32.const 119))
          (i32.store8 (i32.const 145) (i32.const 105))
          (i32.store8 (i32.const 146) (i32.const 100))
          (i32.store8 (i32.const 147) (i32.const 101))
          (i32.store8 (i32.const 148) (i32.const 110))
          ...
          (i32.store8 (i32.const 154) (i32.const 111))
          (i32.store8 (i32.const 155) (i32.const 116))
          (i32.store8 (i32.const 156) (i32.const 58))
          (i32.store8 (i32.const 157) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 26) (call $__i32_to_str (i32.add (i32.load (i32.add (i32.const 276) (i32.const 16))) (i32.load (i32.add (i32.const 296) (i32.const 16)))) (i32.const 158))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $r1 (i32.const 316))
    (local.set $r2 (i32.const 332))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 87))
          (i32.store8 (i32.const 133) (i32.const 105))
          ...
          (i32.store8 (i32.const 143) (i32.const 112))
          (i32.store8 (i32.const 144) (i32.const 97))
          (i32.store8 (i32.const 145) (i32.const 121))
          (i32.store8 (i32.const 146) (i32.const 108))
          (i32.store8 (i32.const 147) (i32.const 111))
          (i32.store8 (i32.const 148) (i32.const 97))
          (i32.store8 (i32.const 149) (i32.const 100))
          (i32.store8 (i32.const 150) (i32.const 58))
          (i32.store8 (i32.const 151) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 20) (call $__f64_to_str (f64.load (i32.add (i32.const 316) (i32.const 8))) (i32.const 152))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 153) (i32.const 58))
          (i32.store8 (i32.const 154) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 23) (call $__f64_to_str (f64.load (i32.add (i32.const 332) (i32.const 8))) (i32.const 155))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    ...
    (call $testUnionSharedFieldWidening )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 348) "\2d\2d\2d\20\53\68\61\72\65\64\20\75\6e\69\6f\6e\20\66\69\65\6c\64\20\77\69\64\65\6e\69\6e\67\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00\07\00\00\00")
  (data (i32.const 268) "\01\00\00\00\09\00\00\00")
  (data (i32.const 276) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\59\40\01\00\00\00")
  (data (i32.const 296) "\01\00\00\00\00\00\00\00\00\00\00\00\00\80\39\40\02\00\00\00")
  (data (i32.const 316) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\d0\3f")
  (data (i32.const 332) "\01\00\00\00\00\00\00\00\00\00\00\00\00\00\10\40")
)