(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 343))
  ...
  (func $testStringTransformations (export "testStringTransformations")  
    (local $padded_ptr i32)
    (local $padded_len i32)
    (local $trimmed_ptr i32)
    (local $trimmed_len i32)
    (local $rawText_ptr i32)
    (local $rawText_len i32)
    (local $replacedOne_ptr i32)
    (local $replacedOne_len i32)
    (local $replacedAll_ptr i32)
    (local $replacedAll_len i32)
    ...
    (local $__str_op_len i32)
        (i32.store (i32.const 0) (i32.const 260))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $padded_ptr (i32.const 308))
      (local.set $padded_len (i32.const 16))
    (call $__str_trim (local.get $padded_ptr) (local.get $padded_len))
      ...
      (local.set $trimmed_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 100))
          (i32.store8 (i32.const 139) (i32.const 58))
          (i32.store8 (i32.const 140) (i32.const 32))
          (call $__str_gather (local.get $trimmed_ptr) (local.get $trimmed_len) (i32.const 141))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (local.get $trimmed_len)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 80))
          ...
          (i32.store8 (i32.const 139) (i32.const 83))
          (i32.store8 (i32.const 140) (i32.const 116))
          (i32.store8 (i32.const 141) (i32.const 97))
          (i32.store8 (i32.const 142) (i32.const 114))
          (i32.store8 (i32.const 143) (i32.const 116))
          (i32.store8 (i32.const 144) (i32.const 58))
          (i32.store8 (i32.const 145) (i32.const 32))
          (call $__str_gather (block (result i32) (call $__str_pad_start (local.get $trimmed_ptr) (local.get $trimmed_len) (i32.const 15) (i32.const 324) (i32.const 1)) (local.set $__str_op_len)) (local.get $__str_op_len) (i32.const 146))
          (i32.store (i32.const 4) (i32.add (i32.const 14) (local.get $__str_op_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (block (result i32) (call $__str_repeat (i32.const 325) (i32.const 1) (i32.const 3)) (local.set $__str_op_len)) (local.get $__str_op_len) (i32.const 142))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (local.get $__str_op_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $rawText_ptr (i32.const 326))
      (local.set $rawText_len (i32.const 11))
    (call $__str_replace (local.get $rawText_ptr) (local.get $rawText_len) (i32.const 337) (i32.const 3) (i32.const 340) (i32.const 3))
      (local.set $replacedOne_len)
      (local.set $replacedOne_ptr)
    (call $__str_replace_all (local.get $rawText_ptr) (local.get $rawText_len) (i32.const 337) (i32.const 3) (i32.const 340) (i32.const 3))
      (local.set $replacedAll_len)
      (local.set $replacedAll_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 82))
          (i32.store8 (i32.const 133) (i32.const 101))
          ...
          (i32.store8 (i32.const 140) (i32.const 70))
          ...
          (call $__str_gather (local.get $replacedOne_ptr) (local.get $replacedOne_len) (i32.const 147))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (local.get $replacedOne_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 101))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store8 (i32.const 140) (i32.const 65))
          ...
          (call $__str_gather (local.get $replacedAll_ptr) (local.get $replacedAll_len) (i32.const 145))
          (i32.store (i32.const 4) (i32.add (i32.const 13) (local.get $replacedAll_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testStringTransformations )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 260) "\2d\2d\2d\20\54\65\73\74\20\32\3a\20\54\72\69\6d\6d\69\6e\67\2c\20\50\61\64\64\69\6e\67\20\26\20\52\65\70\6c\61\63\65\6d\65\6e\74\20\2d\2d\2d\0a")
  (data (i32.const 308) "\20\20\20\68\65\6c\6c\6f\20\57\41\53\4d\20\20\20")
  (data (i32.const 324) "\2a")
  (data (i32.const 325) "\78")
  (data (i32.const 326) "\66\6f\6f\2d\62\61\72\2d\66\6f\6f")
  (data (i32.const 337) "\66\6f\6f")
  (data (i32.const 340) "\62\61\7a")
)