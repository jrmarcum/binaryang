(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 285))
  ...
  (func $_start (export "_start")
    ...
    (local.set $word_ptr (i32.const 260))
      (local.set $word_len (i32.const 3))
    (local.set $fork (i32.const 1))
    (local.set $svar_ptr (i32.const 263))
      (local.set $svar_len (i32.const 4))
    (local.set $tail (i32.const 268))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $fork) (then (i32.const 276)) (else (i32.const 280))) (if (result i32) (local.get $fork) (then (i32.const 4)) (else (i32.const 5))) (i32.const 138))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 136) (i32.const 58))
          (i32.store8 (i32.const 137) (i32.const 32))
          (call $strArrStr (local.get $tail))
          (call $__str_gather (global.get $__str_ret_ptr) (global.get $__str_ret_len) (i32.const 138))
          (i32.store (i32.const 4) (i32.add (i32.const 6) (global.get $__str_ret_len)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\6f\70\74")
  (data (i32.const 263) "\66\6c\61\67")
  (data (i32.const 267) "\5d")
  (data (i32.const 276) "\74\72\75\65")
  (data (i32.const 280) "\66\61\6c\73\65")
  (data (i32.const 268) "\00\00\00\00\00\00\00\00")
)