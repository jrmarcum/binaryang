(module
  ...
  (func $isCircle (param $s i32) (result i32)
    (return (i32.eq (i32.load (i32.add (local.get $s) (i32.const 0))) (i32.const 0)))
  )

  (func $testTypePredicateBasic (export "testTypePredicateBasic")  
    (local $c i32)
    (local $s i32)
    ...
    (local.set $s (local.get $c))
    (local.set $checkResult (call $isCircle (local.get $s)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 67))
          (i32.store8 (i32.const 143) (i32.const 104))
          (i32.store8 (i32.const 144) (i32.const 101))
          (i32.store8 (i32.const 145) (i32.const 99))
          (i32.store8 (i32.const 146) (i32.const 107))
          (i32.store8 (i32.const 147) (i32.const 32))
          (i32.store8 (i32.const 148) (i32.const 82))
          (i32.store8 (i32.const 149) (i32.const 101))
          (i32.store8 (i32.const 150) (i32.const 115))
          (i32.store8 (i32.const 151) (i32.const 117))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 24) (call $__i32_to_str (if (result i32) (local.get $checkResult) (then (i32.const 1)) (else (i32.const 0))) (i32.const 156))))
    ...
    (if (call $isCircle (local.get $s))
      (then
          ...
          (i32.store8 (i32.const 147) (i32.const 32))
          (i32.store8 (i32.const 148) (i32.const 65))
          (i32.store8 (i32.const 149) (i32.const 99))
          ...
          (i32.store8 (i32.const 154) (i32.const 58))
          (i32.store8 (i32.const 155) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 24) (call $__f64_to_str (f64.load (i32.add (local.get $s) (i32.const 8))) (i32.const 156))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testTypePredicateBasic )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 276) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\54\79\70\65\20\50\72\65\64\69\63\61\74\65\20\42\61\73\69\63\20\4e\61\72\72\6f\77\69\6e\67\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\14\40")
)