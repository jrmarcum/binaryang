(module
  ...
  (func $testBasicIntersection (export "testBasicIntersection")  
    (local $ent i32)
    ...
    (;; 1;)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 137) (i32.const 121))
          (i32.store8 (i32.const 138) (i32.const 32))
          (i32.store8 (i32.const 139) (i32.const 73))
          (i32.store8 (i32.const 140) (i32.const 68))
          (i32.store8 (i32.const 141) (i32.const 58))
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 11) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 16))) (i32.const 143))))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 143) (i32.const 118))
          (i32.store8 (i32.const 144) (i32.const 101))
          (i32.store8 (i32.const 145) (i32.const 58))
          (i32.store8 (i32.const 146) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 15) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 20))) (i32.const 147))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 144) (i32.const 83))
          (i32.store8 (i32.const 145) (i32.const 117))
          (i32.store8 (i32.const 146) (i32.const 109))
          (i32.store8 (i32.const 147) (i32.const 58))
          (i32.store8 (i32.const 148) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__f64_to_str (f64.add (f64.load (i32.add (i32.const 260) (i32.const 0))) (f64.load (i32.add (i32.const 260) (i32.const 8)))) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (func $_start (export "_start")
    (call $testBasicIntersection )
    (call $proc_exit (i32.const 0))
  )
  (data (i32.const 284) "\2d\2d\2d\20\54\65\73\74\20\31\3a\20\42\61\73\69\63\20\49\6e\74\65\72\73\65\63\74\69\6f\6e\20\4d\65\72\67\69\6e\67\20\2d\2d\2d\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\29\40\00\00\00\00\00\80\38\40\65\00\00\00\01\00\00\00")
)